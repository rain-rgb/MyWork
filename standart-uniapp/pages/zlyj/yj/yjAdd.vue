		...
		<view class="main">
			...
			<view class="main-item">
				...
				<view class="main-item-input">
					<dict1 dictCode="10" title="请选择设备名称" @choose="Choose1">
					</dict1>
				</view>
			</view>
			<view class="main-item" >
			...
			<view class="main-item">
				<view class="main-item-name">压浆日期：</view>
				<view class="main-item-input" @click="handleyjdate">
					<u--input placeholder="请选择压浆日期" border="surround" v-model="model.yjdate" suffixIcon="calendar"
						disabled suffixIconStyle="color:#4A7FFF;"></u--input>
				</view>
			</view>
			<view class="main-item">
				<view class="main-item-name">设计压力：</view>
				<view class="main-item-input">
					<u--input placeholder="请输入设计压力" border="surround" v-model="model.sjyl"></u--input>
				</view>
			</view>
			<view class="main-item">
				<view class="main-item-name">理论浆量：</view>
				<view class="main-item-input">
					<u--input placeholder="请输理论浆量" border="surround" v-model="model.lljl"></u--input>
				</view>
			</view>
			<!-- <view class="main-item">
				<view class="main-item-name">设计密度：</view>
				<view class="main-item-input">
					<dict dictCode="betlev" title="请输入设计密度" @choose="Choose4">
					</dict>
				</view>
			</view> -->
			<view class="main-item">
				<view class="main-item-name">设计密度：</view>
				<view class="main-item-input">
					<u--input placeholder="请输入设计密度" border="surround" v-model="model.sjmd"></u--input>
				</view>
			</view>
			<view class="main-item">
			...
			<view class="main-item">
				<view class="main-item-name">孔道类型：</view>
				<view class="main-item-input">
					<dict1 dictCode="kdlx" :dictCodeArr="dictCodeArr1" title="请选择孔道类型" @choose="Choose6">
					</dict1>
				</view>
			</view>
			<view class="main-item">
				...
				<view class="main-item-input">
					<u--input placeholder="请输孔道数" border="surround" v-model="model.kds"></u--input>
				</view>
			</view>
			<!-- <view class="main-item">
	...
	export default {
		...
		onLoad(options) {
			...
			if (options.titlesta == 1) {
				this.title = '压浆任务单编辑'
				this.urls = smartbh.yajiangRenwudanedit
			} else {
				...
				this.title = '压浆任务单新增'
				this.urls = smartbh.yajiangRenwudanadd
