<template>
	<view id="shigongphbadd">
		...
		<view>
			...
			<view class="main" v-has="'sgphb:zlrwd'">
				<view class="main-item">
					<view class="biaoqian"></view>
				...
				<view class="main-item">
					<view style="width: 30%;">
						<uni-table>
							...
							<uni-tr>
								<uni-th>
									<u--input placeholder="/" border="none" value="检验批" disabled
										disabledColor="#fff">
									</u--input>
								</uni-th>
							</uni-tr>
							...
							<scroll-view scroll-x="true">
								<view style="width: 2000upx;">
									<uni-table>
										...
										<uni-tr>
											<uni-th v-if="this.model.m1!=null">
												<u--input placeholder="/" border="none" v-model="model.pici1" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m13!=null">
												<u--input placeholder="/" border="none" v-model="model.pici13" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m2!=null">
												<u--input placeholder="/" border="none" v-model="model.pici2" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m3!=null">
												<u--input placeholder="/" border="none" v-model="model.pici3" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m4!=null">
												<u--input placeholder="/" border="none" v-model="model.pici4" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m5!=null">
												<u--input placeholder="/" border="none" v-model="model.pici5" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m6!=null">
												<u--input placeholder="/" border="none" v-model="model.pici6" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m7!=null">
												<u--input placeholder="/" border="none" v-model="model.pici7" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m12!=null">
												<u--input placeholder="/" border="none" v-model="model.pici12" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m8!=null">
												<u--input placeholder="/" border="none" v-model="model.pici8" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m9!=null">
												<u--input placeholder="/" border="none" v-model="model.pici9" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m10!=null">
												<u--input placeholder="/" border="none" v-model="model.pici10" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
											<uni-th v-if="this.model.m11!=null">
												<u--input placeholder="/" border="none" v-model="model.pici11" disabled
													disabledColor="#fff">
												</u--input>
											</uni-th>
										</uni-tr>
	...
	export default {
		...
		methods: {
			...
			getcodelist() {
				this.codeData = []
				let params = {
					dattim_begin: nowtime.getNextPreDate(nowtime.date(), -7),
					...
					if (res.data.success) {
						...
						if (data.length > 0) {
							for (let i = 0; i < data.length; i++) {
								this.codeData.push(data[i].code)
							}
							//console.log("res", res)
						}
					}
			...
			choose1(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici1 = res.data.data
					}
				})
			},
			choose2(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici13 = res.data.data
					}
				})
			},
			choose3(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici2 = res.data.data
					}
				})
			},
			choose4(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici3 = res.data.data
					}
				})
			},
			choose5(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici4 = res.data.data
					}
				})
			},
			choose6(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici5 = res.data.data
					}
				})
			},
			choose7(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici6 = res.data.data
					}
				})
			},
			choose8(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici7 = res.data.data
					}
				})
			},
			choose9(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici12 = res.data.data
					}
				})
			},
			choose10(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici8 = res.data.data
					}
				})
			},
			choose11(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici9 = res.data.data
					}
				})
			},
			choose12(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici10 = res.data.data
					}
				})
			},
			choose13(e) {
				...
				smartsyapi.listpld({
					...
					if (res.data.success) {
						this.model.pici11 = res.data.data
					}
				})
			},
			onChange1(e) {
			...
			sumit() {
				if (
					(this.model.m1 && !this.model.lc1) ||
					(this.model.m2 && !this.model.lc2) ||
					(this.model.m3 && !this.model.lc3) ||
					(this.model.m4 && !this.model.lc4) ||
					(this.model.m5 && !this.model.lc5) ||
					(this.model.m6 && !this.model.lc6) ||
					(this.model.m7 && !this.model.lc7) ||
					(this.model.m8 && !this.model.lc8) ||
					(this.model.m9 && !this.model.lc9) ||
					(this.model.m10 && !this.model.lc10) ||
					(this.model.m12 && !this.model.lc12) ||
					(this.model.m13 && !this.model.lc13)
				) {
					uni.showToast({
						title: "请选择料仓",
						icon: "none",
