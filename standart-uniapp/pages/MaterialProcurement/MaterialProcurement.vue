...
<script>
	...
	export default {
		...
		methods: {
			...
			// 	if (e == 1) {
			// 		uni.navigateTo({
			// 			url: '/pages/MaterialProcurement/DeliveryManagement/DeliveryManagement'
			// 		})
			// 	}

			// 	if (e == 2) {
			// 		uni.navigateTo({
			// 			url: '/pages/MaterialProcurement/check/checklist'
			// 		})
			// 	}
			// 	if (e == 3) {
			// 		uni.navigateTo({
			// 			url: '/pages/MaterialProcurement/check/arrivaledlist'
			// 		})
			// 	}
			// 	if (e == 4) {
			// 		uni.navigateTo({
			// 			url: '/pages/Rawmaterial/Tasklist/Tasklist'
			// 		})
			// 	}
			// 	if (e == 5) {
			// 		uni.navigateTo({
			...
			countchart() {
				this.$http.get(`/wbshebeidetail/wbshebeiDetail/cailiaolist`).then(res => {
					...
					charts.forEach(item => {
						...
						this.mix.series[0].data.push(Number(item.jcsl).toFixed(2))
					})
				})
			},
			//材料用量
