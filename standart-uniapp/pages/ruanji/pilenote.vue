		...
		<u-modal :show="show" @confirm="confirm" showCancelButton @cancel="cancel">
			<view class="screen">
				<view class="screen-modal">
					...
					<view class="screen-modal-item">
						<view class="screen-modal-item-name">里程名称：</view>
						<view class="screen-modal-item-input">
							<u--input placeholder="里程名称" border="surround" v-model="pileMileage"></u--input>
						</view>
					</view>
					<!-- 	<view class="screen-modal-item">
	...
	export default {
		...
		methods: {
			...
			checkDetail(e) {
				...
				uni.navigateTo({
					url: '/pages/ruanji/pilenotedetail?pileno=' + s + '&shebeino=' + e.shebeino + '&id=' +
