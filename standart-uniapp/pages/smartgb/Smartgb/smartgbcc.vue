<template>
	<view class="wrap">
		...
		<view class="charts-box1">
			<qiun-data-charts type="ring" :opts="opts" :chartData="chartData1" style="width: 100%;height:600upx;"  />
		</view>
	</view>
</template>
