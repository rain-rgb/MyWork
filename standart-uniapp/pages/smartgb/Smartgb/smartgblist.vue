  ...
  <view class="wrap">
    ...
    <view class="wrap-section">
      ...
      <view class="wrap-section-box" v-for="(item, index) in Materialdata" :key="index">
        <navigator
          :url="'/pages/smartgb/Smartgb/smartgbdetails?item=' + JSON.stringify(item)"
        >
          ...
          <view class="wrap-section-box-name"
            >进出材料单:<span>{{ item.jinchuliaodanno }}</span></view
          >
          <view class="wrap-section-box-name"
            >材料名称:<span>{{ item.cailiaono_dictText }}</span></view
          >
          <view class="wrap-section-box-name"
            >规格类型:<span>{{ item.beizhu }}</span></view
          >
          <view class="wrap-section-box-name"
            >进场时间:<span>{{ item.jinchangshijian }}</span></view
          >
          <view class="wrap-section-box-name"
            >出场时间:<span>{{ item.chuchangshijian }}</span></view
          >
          <view class="wrap-section-box-name"
            >厂家批次:<span>{{ item.pici }}</span></view
          >
          <!-- <view class="wrap-section-box-name">船号:<span>{{item.cheliangbianhao}}</span></view> -->
          <view class="wrap-section-box-name"
            >前车牌:<span>{{ item.qianchepai }}</span></view
          >
        </navigator>
      </view>
    </view>
...
export default {
  ...
  methods: {
    Materiallist(e) {
      ...
      // this.Materialdata = []
      this.$http
        .get(`/yclsl/wzycljinchanggb/list`, {
          params: {
            column: "id",
            order: "desc",
            pageNo: this.pageNo,
