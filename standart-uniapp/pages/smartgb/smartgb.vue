<template>
	<!-- <view id="smartbh">
		...
		<!-- 页面轮播 -->
		<!-- <view class="swiper">
			<u-swiper :list="list5" @change="e => current = e.current" :autoplay="true">
		...
		<view class="top"> -->
			<!-- <view class="top-item" @click="handleNav(0)">
				<view class="top-item-img" style="background-image: url(../../static/home/dn.png);"></view>
				<view class="top-item-name">智慧拌合中心</view>
			</view>
			<view class="top-item" @click="handleNav(1)">
				<view class="top-item-img" style="background-image: url(../../static/home/zz.png);"></view>
				<view class="top-item-name">混凝土浇筑</view>
			</view>
			<view class="top-item" @click="handleNav(2)">
				<view class="top-item-img" style="background-image: url(../../static/home/jc.png);"></view>
				<view class="top-item-name">料位动态监测</view>
			</view>
			<view class="top-item" @click="handleNav(3)">
				<view class="top-item-img" style="background-image: url(../../static/home/gb.png);"></view>
				<view class="top-item-name">智慧过磅</view>
			</view>
			<view class="top-item" @click="handleNav(4)">
				<view class="top-item-img" style="background-image: url(../../static/home/dd.png);"></view>
				<view class="top-item-name">车辆调度</view>
			</view>
			<view class="top-item" @click="handleNav(5)">
				<view class="
				top-item-img" style="background-image: url(../../static/home/hj.png);"></view>
				<view class="top-item-name">环保监测</view>
			</view>
		</view> -->
		<!-- 消息中心 -->
		<!-- <view class="news">
 ...
 <script>
	...
	// 			if (e == 2) {
	// 				uni.navigateTo({
	// 					url: '/pages/smartbh/mix/Silomonitor'
	// 				})
	// 			}
	// 			if (e == 3) {
	// 				uni.navigateTo({
	// 					url: '/pages/smartgb/Smartgb/smartgblist'
	// 				})
	// 			}
	// 			if (e == 4) {
	// 				// uni.navigateTo({
	...
	// 			if (e == 5) {
	// 				uni.navigateTo({
	// 					url: '/pages/smartgb/Smartenv/smartenv'
	// 				})
	// 			}
	// 		},
			// getpourtotal(e) {
