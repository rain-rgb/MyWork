<template>
	<u-popup
		...
		@close="closeHandler"
	>
		<view v-if="search" style="padding: 2upx;margin-top: 10upx;" class="">
			<u-search shape="shape" placeholder="输入配比通知单" v-model="keyword" @custom="custom"></u-search>
			<u-divider style="width: 100%; margin: 10upx auto 0;"></u-divider>
		</view>
