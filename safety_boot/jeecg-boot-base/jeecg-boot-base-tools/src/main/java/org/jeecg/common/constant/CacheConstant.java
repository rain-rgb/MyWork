...
public interface CacheConstant {
	 ...
	 * 全部分部分项信息缓存
	 */
	public static final String SYS_DEPARTS_CACHE_PROJECT = "sys:cache:depart:alldata:project";
	/**
	 * 全部分部分项ids缓存
	 */
	public static final String SYS_DEPART_IDS_CACHE_PROJECT = "sys:cache:depart:allids:project";
	/**
	 * 全部部门ids缓存
	 */
