...
public class WzLiaoCangPushData implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (null == selectsysconfigone) {
            log.info(String.format("未获取到甬金瞿上推送粉料罐余量任务的配置信息" + DateUtils.now()));
            return;
        }
        //当前数据检测到的目标id
...
//            }
            ...
            if (returncode == 200) {
                ...
                log.info(String.format("甬金瞿上三标料仓推送失败!" + "erro" + jsonObject1.get("msg")  ));
            }
            pushandreturnService.saveData(1,String.valueOf(sendDataList),"甬金瞿上推送粉料罐余量",body);
        }
