...
public class WztaizhangJobRC47 implements Job {
    @Autowired
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        List<Wzycljinchanggb> selectycljinchangones = wzycljinchanggbService.selectycljinchangListRc("rcgs", 0,"");//没有进行过台账统计的数据
        ...
        for (Wzycljinchanggb selectycljinchangone : selectycljinchangones) {
            ...
            String beizhu = StringUtils.isNotBlank( selectycljinchangone.getBeizhu()) ?  selectycljinchangone.getBeizhu() : "";
...
//                }
                ...
                if (StrUtil.isNotBlank(beizhu) &&  beizhu.equals("人工录入")){
                    Format fm = new DecimalFormat("000");
                   String ss= String.valueOf(id);
                    wztaizhang.setIsfinish(1);
                       // 人工录入 queryone = null
                    pici =( StringUtils.isNotBlank(pici)?pici:"/")+ "-" + ss ;
                } else if (StrUtil.isBlank(pici) || "/".equals(pici)  ) {
                ...
                if (queryone == null) {
                    ...
                    if(chuangchangshijian != null){
                        wztaizhang.setChuchangshijian(sdf.parse(chuangchangshijian));
                    }
