...
public class bhzJob1biao implements Job {
    @Autowired
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        //根据定时任务配置表获取一条配置信息
        SysConfig selectsysconfigone = sysConfigService.selectsysconfigone(JobUtil.KZ_BHZ1B);//瑞苍拌合站
        //如果他等于空
        ...
        List<BhzCementBase> bhzCementBases = bhzCementBaseService.selectLists1b(shebeilist, curid);
        ...
        for (BhzCementBase bhzCementBase : bhzCementBases) {
            ...
            Integer mixNo = 0;
            String mixName = "";
            if ("kzgsbhz01_01_01".equals(shebeiNo)) {
                projId = 81501;
                mixNo = 1;
                mixName = "柯诸项目1标拌合站1号线";
            }
            if ("kzgsbhz01_01_02".equals(shebeiNo)) {
                projId = 81501;
                mixNo = 2;
                mixName = "柯诸项目1标拌合站2号线";
            }
            if ("kzgs1b2z".equals(shebeiNo)) {
                projId = 81501;
                mixName = "柯诸项目1标拌合站3号线";
                mixNo = 3;
            }
            if ("kz1b2z02".equals(shebeiNo)) {
                projId = 81501;
                mixName = "柯诸项目1标拌合站4号线";
                mixNo = 4;
            }
            if ("kzgsbhz01_03_01".equals(shebeiNo)) {
                projId = 81501;
                mixName = "柯诸项目1标拌合站5号线";
                mixNo = 5;
            }
            ...
            Integer cardIdx = 0;
            if (StringUtils.isNotBlank(bhzCementBase.getPanhao())) {
                cardIdx = bhzCementBaseService.getCarCount(bhzCementBase);
                sendDate.set("carNumber", bhzCementBase.getCarno());
                sendDate.set("trayIdx", bhzCementBase.getPanhao());//盘次
            ...
            if (StringUtils.isNotBlank(bhzCementBase.getPanhao())) {
                ...
                cardata.set("trayIdx", bhzCementBase.getPanhao());//盘次
            ...
            sysConfigService.updateSysConfig(JobUtil.KZ_BHZ1B, id);//根据传过来的唯一值来修改当前判断到的数据id
        }
    }
}
