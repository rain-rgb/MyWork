...
public class SysDictController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/queryMayDictItems", method = RequestMethod.GET)
	public Result<?> queryMayDictItems(HttpServletRequest request,String dictCode) {
		Map<String, List<DictModel>> res = new HashMap<String, List<DictModel>>();
		res = sysDictService.queryMayDictItems(dictCode);
		return Result.ok(res);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/getDictItemsGx")
