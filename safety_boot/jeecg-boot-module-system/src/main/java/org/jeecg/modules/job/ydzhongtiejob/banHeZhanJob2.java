...
public class banHeZhanJob2 implements Job {
    @Autowired
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        //根据定时任务配置表获取一条配置信息
        SysConfig selectsysconfigone = sysConfigService.selectsysconfigone(JobUtil.YB_GTBHZ2);//开投
        //如果他等于空
        ...
        for (BhzCementBase bhzCementBase : bhzCementBases) {
            ...
            bhzCementBaseService.updateById(bhzCementBase1);
            sysConfigService.updateSysConfig(JobUtil.YB_GTBHZ2, id);//根据传过来的唯一值来修改当前判断到的数据id
        }
    }
}
