 ...
 * \* Date: 2021/10/19
 * \* Time: 14:44
 * \* Description:  淮阜枢纽(钉考勤数据接入) 获取用户打卡信息
 * \
 */
@Slf4j
@PersistJobDataAfterExecution
@DisallowConcurrentExecution
public class HFDingTalkJob implements Job {
    @Autowired
    ...
    private static String APPKEY="dingwhcwztil3r2f6wyu";//
    private static String APPSECRET="GrsIHagK8muLfUGnFlit5FQ9Y7s5ULE6jSkPBDfgtmxRJebppwHh2InfW1pTwxc7";
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        SysConfig selectsysconfigone = sysConfigService.selectsysconfigone(JobUtil.HFSN_MJKQ_PULL);
        //如果他为空,日志，并直接return
