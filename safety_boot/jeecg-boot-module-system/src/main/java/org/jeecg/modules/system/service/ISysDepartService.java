...
public interface ISysDepartService extends IService<SysDepart>{
    ...
    List<SysDepartTreeModel> queryTreeListByOrgCode();
    ...
    SysDepart queryone(String sysorgcode);

    SysDepart querynameabbrList(String depart_name,String depart_name_abbr);

    /**
     * 根据用户传过来的 create_by 里面的项目全称去查询对应的 depart_name_abbr  也就是这个项目下的所有分部、监理等
     * @param depart_name_abbr
     * @return
     */
    List<SysDepart> querydepart_name_abbrList(String depart_name_abbr);
    ...
    List<SysDepart> getsysDepartlist(String id);

    List<SysDepart> getsysDepartlists(String id, String orgCategory);

    SysDepart selectbyorgcode(String sysOrgCode, int i);
    ...
    SysDepart queryoneByproject(String projectid,String sectionid);
}
