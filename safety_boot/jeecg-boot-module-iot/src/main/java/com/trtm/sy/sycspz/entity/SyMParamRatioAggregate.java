 ...
 */
@Data
@TableName("sy_m_param_ratio_aggregate")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="sy_m_param_ratio_aggregate对象", description="sy_m_param_ratio_aggregate")
public class SyMParamRatioAggregate implements Serializable {
