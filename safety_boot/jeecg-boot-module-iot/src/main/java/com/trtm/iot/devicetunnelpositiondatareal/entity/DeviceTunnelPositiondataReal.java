 ...
 */
@Data
@TableName("device_tunnel_positiondata_real")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "device_tunnel_positiondata_real对象", description = "人员定位实时表")
public class DeviceTunnelPositiondataReal implements Serializable {
    ...
    private java.lang.Integer zhiwuid;
