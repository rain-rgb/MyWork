package com.trtm.iot.bhzSwShaifenShiyan.entity;
 ...
 */
@Data
@TableName("bhz_sw_shaifen_shiyan")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_sw_shaifen_shiyan对象", description="bhz_sw_shaifen_shiyan")
public class BhzSwShaifenShiyan implements Serializable {
