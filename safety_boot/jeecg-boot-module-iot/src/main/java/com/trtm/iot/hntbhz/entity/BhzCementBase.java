...
public class BhzCementBase implements Serializable {
    ...
    @Dict(dictTable = "scheduling_car", dicText = "Vehicle", dicCode = "danhao")
...
//    @Excel(name = "超标等级", width = 15)
    ...
    private Integer statistics1;
    private Integer cbStatistics;
    private Integer bhStatus;
    private Integer isorder;
    private Integer ispanding;
    private Integer cheflag;//本车完成标志 0 未完成  1已完成
    private String carno;//车牌号
    private String driver;//驾驶员
    private String panhao;//盘号
    private Integer isstz;
