  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="构件编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="componentId">
              <a-input v-model="model.componentId" placeholder="请输入构件编号"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="构件名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="componentName">
              <a-input v-model="model.componentName" placeholder="请输入构件名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="构件规格型号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="componentModel">
              <a-input v-model="model.componentModel" placeholder="请输入构件规格型号"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="构件类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="componentType">
              <a-input v-model="model.componentType" placeholder="请输入构件类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/rebarComponent/rebarComponent/add",
          edit: "/rebarComponent/rebarComponent/edit",
          queryById: "/rebarComponent/rebarComponent/queryById"
        }
      }
    },
    computed: {
