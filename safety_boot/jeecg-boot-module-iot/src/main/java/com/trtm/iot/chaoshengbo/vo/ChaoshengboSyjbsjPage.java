package com.trtm.iot.chaoshengbo.vo;
...
public class ChaoshengboSyjbsjPage {
	...
	private List<ChaoshengboSybltsj> chaoshengboSybltsjList;//超声波波列图数据
	private List<ChaoshengboSybsj> chaoshengboSybsjList;//超声波实验包数据
    private List<ChaoshengboSydsj> chaoshengboSydsjList;//超声波实验点数据
    private List<ChaoshengboSyjsb> chaoshengboSyjsbList;
    private List<ChaoshengboSyljzs> chaoshengboSyljzsList;//超声波临界值数据
    private List<ChaoshengboSyqxsj> chaoshengboSyqxsjList;//超声波实验缺陷数据
}
