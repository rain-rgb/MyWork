package com.trtm.iot.zhiliangrenwudan.entity;
...
public class Zhiliangrenwudan implements Serializable {
    ...
    private java.lang.Integer wiretiestatus;
	/**浇筑状态*/
	@Excel(name = "浇筑状态", width = 15)
    @ApiModelProperty(value = "浇筑状态")
    private java.lang.Integer jiaozhustatus;
	/**收面静置状态*/
	@Excel(name = "收面静置状态", width = 15)
    @ApiModelProperty(value = "收面静置状态")
    private java.lang.Integer jingzhistatus;
	/**蒸养状态1*/
	@Excel(name = "蒸养状态1", width = 15)
    @ApiModelProperty(value = "蒸养状态1")
    private java.lang.Integer zhengyangstatus1;
	/**蒸养状态2*/
	@Excel(name = "蒸养状态2", width = 15)
    @ApiModelProperty(value = "蒸养状态2")
    private java.lang.Integer zhengyangstatus2;
	/**张拉状态*/
	@Excel(name = "张拉状态", width = 15)
    @ApiModelProperty(value = "张拉状态")
    private java.lang.Integer zhanglastatus;
	/**提梁状态*/
	@Excel(name = "提梁状态", width = 15)
    @ApiModelProperty(value = "提梁状态")
    private java.lang.Integer tiliangstatus;
    /**封端状态*/
    @Excel(name = "封端状态", width = 15)
    @ApiModelProperty(value = "封端状态")
    private java.lang.Integer fengduanstatus;
    /**唯一id*/
    ...
    @Dict(dicCode = "cunliangstatus")
    private java.lang.Integer cunliangstatus;
    /**台座编号*/
    @Excel(name = "台座编号", width = 15)
    @ApiModelProperty(value = "台座编号")
    @Dict(dictTable = "zhiliang_taizuo_cfg", dicText = "taizuoname", dicCode = "taizuono")
