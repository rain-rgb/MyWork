  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/bhzSwJipeiStatistics/bhzSwJipeiStatistics/add",
          edit: "/bhzSwJipeiStatistics/bhzSwJipeiStatistics/edit",
          queryById: "/bhzSwJipeiStatistics/bhzSwJipeiStatistics/queryById"
        }
      }
    },
    computed: {
