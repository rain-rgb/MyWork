package com.trtm.iot.jiaozhu.entity;
 ...
 */
@Data
@TableName("pouring_procedure")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="pouring_procedure对象", description="混凝土浇筑工序表信息")
public class PouringProcedure implements Serializable {
