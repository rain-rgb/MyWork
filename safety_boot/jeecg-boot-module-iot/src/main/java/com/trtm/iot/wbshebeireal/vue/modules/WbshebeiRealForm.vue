    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="是否发送信息0发送消息1为没发送消息" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sffs">
              <a-input v-model="model.sffs" placeholder="请输入是否发送信息0发送消息1为没发送消息"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="是否报警0为报警1为不报警" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="sfbj">
              <a-input v-model="model.sfbj" placeholder="请输入是否报警0为报警1为不报警"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/wbshebeireal/wbshebeiReal/add",
          edit: "/wbshebeireal/wbshebeiReal/edit",
          queryById: "/wbshebeireal/wbshebeiReal/queryById"
        }
      }
    },
    computed: {
