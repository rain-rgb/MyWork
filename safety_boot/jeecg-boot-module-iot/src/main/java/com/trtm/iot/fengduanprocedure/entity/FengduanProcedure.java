package com.trtm.iot.fengduanprocedure.entity;
 ...
 */
@Data
@TableName("fengduan_procedure")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="fengduan_procedure对象", description="封端工序")
public class FengduanProcedure implements Serializable {
