package com.trtm.iot.bhzcementwaterratereal.entity;
 ...
 */
@Data
@TableName("bhz_cement_waterrate_real")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_cement_waterrate_real对象", description="bhz_cement_waterrate_real")
public class BhzCementWaterrateReal implements Serializable {
