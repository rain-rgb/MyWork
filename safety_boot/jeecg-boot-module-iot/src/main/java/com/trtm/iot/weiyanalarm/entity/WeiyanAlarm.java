package com.trtm.iot.weiyanalarm.entity;
 ...
 */
@Data
@TableName("weiyan_alarm")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="weiyan_alarm对象", description="监控量测报警数据表")
public class WeiyanAlarm implements Serializable {
