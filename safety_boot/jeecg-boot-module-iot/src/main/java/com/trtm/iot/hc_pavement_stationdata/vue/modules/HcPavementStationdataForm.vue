...
摊铺温度（°C）" prop="pavingtemperature">
              <a-input placeholder="请输入
摊铺温度（°C）" v-model="model.pavingtemperature"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="
温度离析（°C）" prop="temperaturesegregation">
              <a-input placeholder="请输入
温度离析（°C）" v-model="model.temperaturesegregation"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="
摊铺速度（m/min）" prop="pavingspeed">
              <a-input-number placeholder="请输入
摊铺速度（m/min）" style="width: 100%" v-model="model.pavingspeed" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="
钢轮欠压率" prop="steelrate">
              <a-input placeholder="请输入
钢轮欠压率" v-model="model.steelrate"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="
胶轮欠压率" prop="rubberrate">
              <a-input placeholder="请输入
胶轮欠压率" v-model="model.rubberrate"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
  ...
  export default {
    name: 'HcPavementStationdataForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/hc_pavement_stationdata/hcPavementStationdata/add",
          edit: "/hc_pavement_stationdata/hcPavementStationdata/edit",
          queryById: "/hc_pavement_stationdata/hcPavementStationdata/queryById"
        }
      }
    },
    computed: {
