package com.trtm.iot.hctfysworkareaoverhandler.entity;
 ...
 */
@Data
@TableName("hc_tfysworkarea_over_handler")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="hc_tfysworkarea_over_handler对象", description="hc_tfysworkarea_over_handler")
public class HcTfysworkareaOverHandler implements Serializable {
