package com.trtm.iot.wzshouhuodanwei.entity;
 ...
 */
@Data
@TableName("wzshouhuodanwei")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wzshouhuodanwei对象", description="物资收获单位信息表")
public class Wzshouhuodanwei implements Serializable {
	...
	/**收货单位名*/
	@Excel(name = "收货单位名", width = 15)
    @ApiModelProperty(value = "收货单位名")
    private java.lang.String gongyingshangname;
	/**收货单位名字母缩写*/
	@Excel(name = "收货单位名字母缩写", width = 15)
    @ApiModelProperty(value = "收货单位名字母缩写")
	...
	/**收货材料*/
	@Excel(name = "收货材料", width = 15)
    @ApiModelProperty(value = "收货材料")
	...
	/**收货材料名*/
	@Excel(name = "收货材料名", width = 15)
    @ApiModelProperty(value = "收货材料名")
