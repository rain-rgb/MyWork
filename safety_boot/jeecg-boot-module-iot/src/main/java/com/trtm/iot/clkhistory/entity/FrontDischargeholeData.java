package com.trtm.iot.clkhistory.entity;
 ...
 */
@Data
@TableName("front_dischargehole_data")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="front_dischargehole_data对象", description="出料口测温历史数据表")
public class FrontDischargeholeData implements Serializable {
    ...
    private java.math.BigDecimal devicename;
	/**sensortypeid*/
