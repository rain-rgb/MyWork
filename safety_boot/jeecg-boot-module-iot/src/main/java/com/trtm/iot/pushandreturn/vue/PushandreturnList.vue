<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button @click="handleExportXls('接口推送信息')" icon="download" type="primary">导出</a-button>
    ...
    <pushandreturn-modal @ok="modalFormOk" ref="modalForm"></pushandreturn-modal>
  </a-card>
</template>
...
<script>
  ...
  import PushandreturnModal from './modules/PushandreturnModal'

  export default {
    name: 'PushandreturnList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/pushandreturn/pushandreturn/list",
          delete: "/pushandreturn/pushandreturn/delete",
          deleteBatch: "/pushandreturn/pushandreturn/deleteBatch",
          exportXlsUrl: "/pushandreturn/pushandreturn/exportXls",
          importExcelUrl: "pushandreturn/pushandreturn/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'pushdataid',text:'推送数据id'})
        fieldList.push({type:'string',value:'pushname',text:'推送名称'})
        fieldList.push({type:'string',value:'pushjson',text:'推送数据'})
        fieldList.push({type:'string',value:'returnvalue',text:'返回值'})
