package com.trtm.iot.devicepowerhistorydata.entity;
 ...
 */
@Data
@TableName("device_power_historydata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_power_historydata对象", description="device_power_historydata")
public class DevicePowerHistorydata implements Serializable {
