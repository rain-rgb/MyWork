 ...
 */
@Data
@TableName("jikeng_shuiwei")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="jikeng_shuiwei对象", description="jikeng_shuiwei")
public class JikengShuiwei implements Serializable {
	...
	/**水位cm*/
	@Excel(name = "水位cm", width = 15)
    @ApiModelProperty(value = "水位cm")
