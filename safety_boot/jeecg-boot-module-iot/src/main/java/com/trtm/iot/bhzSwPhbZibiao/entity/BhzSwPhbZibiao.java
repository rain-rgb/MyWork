package com.trtm.iot.bhzSwPhbZibiao.entity;
 ...
 */
@Data
@TableName("bhz_sw_phb_zibiao")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_sw_phb_zibiao对象", description="水稳理论配合比子表")
public class BhzSwPhbZibiao implements Serializable {
