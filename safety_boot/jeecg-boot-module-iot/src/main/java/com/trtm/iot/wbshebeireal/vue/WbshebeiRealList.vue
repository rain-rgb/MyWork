<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('电子锁实时数据表')">导出</a-button>
    ...
    <wbshebei-real-modal ref="modalForm" @ok="modalFormOk"></wbshebei-real-modal>
  </a-card>
</template>
...
<script>
  ...
  import WbshebeiRealModal from './modules/WbshebeiRealModal'

  export default {
    name: 'WbshebeiRealList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/wbshebeireal/wbshebeiReal/list",
          delete: "/wbshebeireal/wbshebeiReal/delete",
          deleteBatch: "/wbshebeireal/wbshebeiReal/deleteBatch",
          exportXlsUrl: "/wbshebeireal/wbshebeiReal/exportXls",
          importExcelUrl: "wbshebeireal/wbshebeiReal/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'sffs',text:'是否发送信息0发送消息1为没发送消息',dictCode:''})
        fieldList.push({type:'string',value:'sfbj',text:'是否报警0为报警1为不报警',dictCode:''})
