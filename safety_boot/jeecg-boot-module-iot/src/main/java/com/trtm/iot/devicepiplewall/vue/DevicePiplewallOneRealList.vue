<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('device_piplewall_one_real')">导出</a-button>
    ...
    <device-piplewall-one-real-modal ref="modalForm" @ok="modalFormOk"></device-piplewall-one-real-modal>
  </a-card>
</template>
...
<script>
  ...
  import DevicePiplewallOneRealModal from './modules/DevicePiplewallOneRealModal'

  export default {
    name: 'DevicePiplewallOneRealList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      DevicePiplewallOneRealModal
    },
    data () {
      return {
        description: 'device_piplewall_one_real管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/devicepiplewall/devicePiplewallOneReal/list",
          delete: "/devicepiplewall/devicePiplewallOneReal/delete",
          deleteBatch: "/devicepiplewall/devicePiplewallOneReal/deleteBatch",
          exportXlsUrl: "/devicepiplewall/devicePiplewallOneReal/exportXls",
          importExcelUrl: "devicepiplewall/devicePiplewallOneReal/importExcel",
