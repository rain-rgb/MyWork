<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button @click="handleExportXls('获取逐桩数据')" icon="download" type="primary">导出</a-button>
    ...
    <hc-pavement-stationdata-modal @ok="modalFormOk" ref="modalForm"></hc-pavement-stationdata-modal>
  </a-card>
</template>
...
<script>
  ...
  import HcPavementStationdataModal from './modules/HcPavementStationdataModal'

  export default {
    name: 'HcPavementStationdataList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      HcPavementStationdataModal
    },
    data () {
      return {
        description: '获取逐桩数据管理页面',
        // 表头
        columns: [
          {
            title: '#',
...
胶轮欠压率',
        ...
        url: {
          list: "/hc_pavement_stationdata/hcPavementStationdata/list",
          delete: "/hc_pavement_stationdata/hcPavementStationdata/delete",
          deleteBatch: "/hc_pavement_stationdata/hcPavementStationdata/deleteBatch",
          exportXlsUrl: "/hc_pavement_stationdata/hcPavementStationdata/exportXls",
          importExcelUrl: "hc_pavement_stationdata/hcPavementStationdata/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'pavingtemperature',text:'
摊铺温度（°C）'})
        fieldList.push({type:'string',value:'temperaturesegregation',text:'
温度离析（°C）'})
        fieldList.push({type:'number',value:'pavingspeed',text:'
摊铺速度（m/min）'})
        ...
        fieldList.push({type:'string',value:'steelrate',text:'
钢轮欠压率'})
        fieldList.push({type:'string',value:'rubberrate',text:'
胶轮欠压率'})
