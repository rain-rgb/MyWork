package com.trtm.iot.syjoverhandler.entity;
 ...
 */
@Data
@TableName("syj_over_handler")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="syj_over_handler对象", description="试验机处置审核表")
public class SyjOverHandler implements Serializable {
	...
	/**对应试验机主表SYJID*/
	@Excel(name = "对应试验机主表SYJID", width = 15)
    @ApiModelProperty(value = "对应试验机主表SYJID")
	...
	@Excel(name = "超标状态：0为未处理，10为施工方已处理，20为监理方已处理 30监理驳回 40 指挥部已审核 50 指挥部已驳回", width = 15)
    @ApiModelProperty(value = "超标状态：0为未处理，10为施工方已处理，20为监理方已处理 30监理驳回 40 指挥部已审核 50 指挥部已驳回")
