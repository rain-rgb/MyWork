        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="浇筑状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['status']" placeholder="请输入浇筑状态" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="总方量" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['mete']" placeholder="请输入总方量" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jiaozhu/pouringProcedure/add",
          edit: "/jiaozhu/pouringProcedure/edit",
          queryById: "/jiaozhu/pouringProcedure/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'uuid','status','starttime','endtime','mete','createBy','createTime'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'uuid','status','starttime','endtime','mete','createBy','createTime'))
      },
    }
  }
</script>