 ...
 */
@Data
@TableName("lm_sw_files")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="lm_sw_files对象", description="lm_sw_files")
public class LmSwFiles implements Serializable {
    ...
    @Dict(dicCode = "lmswsgjd")
    private java.lang.String sgjd;
	/**文件类型*/
	@Excel(name = "文件类型", width = 15)
    @ApiModelProperty(value = "文件类型")
    @Dict(dicCode = "lmswfiles")
