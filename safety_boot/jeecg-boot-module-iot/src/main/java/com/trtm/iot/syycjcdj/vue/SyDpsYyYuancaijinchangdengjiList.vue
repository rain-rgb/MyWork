<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('sy_dps_yy_yuancaijinchangdengji')">导出</a-button>
    ...
    <sy-dps-yy-yuancaijinchangdengji-modal ref="modalForm" @ok="modalFormOk"></sy-dps-yy-yuancaijinchangdengji-modal>
  </a-card>
</template>
...
<script>
  ...
  import SyDpsYyYuancaijinchangdengjiModal from './modules/SyDpsYyYuancaijinchangdengjiModal'

  export default {
    name: 'SyDpsYyYuancaijinchangdengjiList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      SyDpsYyYuancaijinchangdengjiModal
    },
    data () {
      return {
        description: 'sy_dps_yy_yuancaijinchangdengji管理页面',
        // 表头
        columns: [
          {
            title: '#',
          ...
          {
            title:'sgdwwaiweizhuangtai',
            align:"center",
            dataIndex: 'sgdwwaiweizhuangtai'
          },
          {
            title: '操作',
            dataIndex: 'action',
        ...
        url: {
          list: "/syycjcdj/syDpsYyYuancaijinchangdengji/list",
          delete: "/syycjcdj/syDpsYyYuancaijinchangdengji/delete",
          deleteBatch: "/syycjcdj/syDpsYyYuancaijinchangdengji/deleteBatch",
          exportXlsUrl: "/syycjcdj/syDpsYyYuancaijinchangdengji/exportXls",
          importExcelUrl: "syycjcdj/syDpsYyYuancaijinchangdengji/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'guigexinghao',text:'材料规格'})
        ...
        fieldList.push({type:'string',value:'jinchangshuliang',text:'进场数量(代表数量)'})
        ...
        fieldList.push({type:'string',value:'guigexinghao1',text:'guigexinghao1'})
        ...
        fieldList.push({type:'string',value:'sgdwwaiweizhuangtai',text:'sgdwwaiweizhuangtai'})
