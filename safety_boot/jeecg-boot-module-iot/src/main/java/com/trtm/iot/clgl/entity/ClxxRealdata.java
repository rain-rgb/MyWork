package com.trtm.iot.clgl.entity;
...
@ApiModel(value="front_device_realdata对象", description="车辆信息实时数据表")
public class ClxxRealdata implements Serializable {
    ...
    @Excel(name = "gpsTime", width = 15)
    @ApiModelProperty(value = "gpsTime")
    private java.lang.Integer gpstime;
    @Excel(name = "signalTime", width = 15)
    @ApiModelProperty(value = "signalTime")
    private java.lang.Integer signaltime;

    @Excel(name = "高讯睿矩基站卡号", width = 15)
    @ApiModelProperty(value = "高讯睿矩基站卡号")
