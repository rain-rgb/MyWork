 ...
 */
@Data
@TableName("device_tower_historydata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_tower_historydata对象", description="device_tower_historydata")
public class DeviceTowerHistorydata implements Serializable {
    ...
    /**风速预警1*/
    @Excel(name = "风速预警1", width = 15)
    @ApiModelProperty(value = "风速预警1")
    private java.lang.Integer overval1Wind1;
    /**主力矩预警额定力矩85%预警*/
    @Excel(name = "主力矩预警额定力矩85%预警", width = 15)
    @ApiModelProperty(value = "主力矩预警额定力矩85%预警")
    private java.lang.Integer overval3Vicemoment1;
    /**副力矩预警额定力矩85%预警*/
    @Excel(name = "副力矩预警额定力矩85%预警", width = 15)
    @ApiModelProperty(value = "副力矩预警额定力矩85%预警")
    private java.lang.Integer overval4Vicemoment2;
    /**风速预警2*/
    @Excel(name = "风速预警2", width = 15)
    @ApiModelProperty(value = "风速预警2")
    private java.lang.Integer overval5Wind2;
    /**塔体垂直度6度偏差预警*/
    @Excel(name = "塔体垂直度6度偏差预警", width = 15)
    @ApiModelProperty(value = "塔体垂直度6度偏差预警")
    private java.lang.Integer overval6Tilt;
}
