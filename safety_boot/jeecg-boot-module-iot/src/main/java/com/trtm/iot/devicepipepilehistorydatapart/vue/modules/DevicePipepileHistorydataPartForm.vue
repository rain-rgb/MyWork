    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="平均速度(cm/min)" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="partSpeed">
              <a-input v-model="model.partSpeed" placeholder="请输入平均速度(cm/min)"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="压桩力(KN)" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="partUpress">
              <a-input v-model="model.partUpress" placeholder="请输入压桩力(KN)"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="夹持力(KN)" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="partDpress">
              <a-input v-model="model.partDpress" placeholder="请输入夹持力(KN)"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
  ...
  export default {
    name: 'DevicePipepileHistorydataPartForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/devicepipepilehistorydatapart/devicePipepileHistorydataPart/add",
          edit: "/devicepipepilehistorydatapart/devicePipepileHistorydataPart/edit",
          queryById: "/devicepipepilehistorydatapart/devicePipepileHistorydataPart/queryById"
        }
      }
    },
    computed: {
