 ...
 */
@Data
@TableName("device_high_formwork")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_high_formwork对象", description="device_high_formwork")
public class DeviceHighFormwork implements Serializable {
