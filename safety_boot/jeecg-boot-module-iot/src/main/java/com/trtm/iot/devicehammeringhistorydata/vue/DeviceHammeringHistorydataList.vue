<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('device_hammering_historydata')">导出</a-button>
    ...
    <device-hammering-historydata-modal ref="modalForm" @ok="modalFormOk"></device-hammering-historydata-modal>
  </a-card>
</template>
...
<script>
  ...
  import DeviceHammeringHistorydataModal from './modules/DeviceHammeringHistorydataModal'

  export default {
    name: 'DeviceHammeringHistorydataList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      DeviceHammeringHistorydataModal
    },
    data () {
      return {
        description: 'device_hammering_historydata管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/devicehammeringhistorydata/deviceHammeringHistorydata/list",
          delete: "/devicehammeringhistorydata/deviceHammeringHistorydata/delete",
          deleteBatch: "/devicehammeringhistorydata/deviceHammeringHistorydata/deleteBatch",
          exportXlsUrl: "/devicehammeringhistorydata/deviceHammeringHistorydata/exportXls",
          importExcelUrl: "devicehammeringhistorydata/deviceHammeringHistorydata/importExcel",
