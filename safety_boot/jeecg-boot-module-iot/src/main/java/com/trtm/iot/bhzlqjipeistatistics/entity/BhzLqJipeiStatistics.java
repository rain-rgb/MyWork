package com.trtm.iot.bhzlqjipeistatistics.entity;
 ...
 */
@Data
@TableName("bhz_lq_jipei_statistics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_lq_jipei_statistics对象", description="沥青级配统计信息表")
public class BhzLqJipeiStatistics implements Serializable {
