package com.trtm.iot.ztwzjinmaterial.entity;
 ...
 */
@Data
@TableName("ztwzjinmaterial")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="ztwzjinmaterial对象", description="中铁进厂子表")
public class Ztwzjinmaterial implements Serializable {
	...
	/**BIGINT	添加人*/
	@Excel(name = "BIGINT	添加人", width = 15)
    @ApiModelProperty(value = "BIGINT	添加人")
