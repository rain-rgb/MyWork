      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title:'设计构件数量',
            align:"center",
            dataIndex: 'designComponentNumber'
          },
          {
            title:'领用构件数量',
            align:"center",
            dataIndex: 'actualComponentNumber'
          },
          {
            title: '操作',
            dataIndex: 'action',
