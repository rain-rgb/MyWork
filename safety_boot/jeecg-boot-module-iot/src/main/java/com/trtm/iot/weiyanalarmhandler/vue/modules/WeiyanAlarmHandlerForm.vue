  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="唯一ID" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="batchNo">
              <a-input v-model="model.batchNo" placeholder="请输入唯一ID"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="处置信息" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="dispositionInformatio">
              <a-input v-model="model.dispositionInformatio" placeholder="请输入处置信息"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="处置状态：0为未处理，10为施工方已处理，20为监理方已处理 30驳回" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="overproofStatus">
              <a-input-number v-model="model.overproofStatus" placeholder="请输入处置状态：0为未处理，10为施工方已处理，20为监理方已处理 30驳回" style="width: 100%" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/weiyanalarmhandler/weiyanAlarmHandler/add",
          edit: "/weiyanalarmhandler/weiyanAlarmHandler/edit",
          queryById: "/weiyanalarmhandler/weiyanAlarmHandler/queryById"
        }
      }
    },
    computed: {
