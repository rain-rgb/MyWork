        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="张拉状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['status']" placeholder="请输入张拉状态" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhanglaprocedure/zhanglaProcedure/add",
          edit: "/zhanglaprocedure/zhanglaProcedure/edit",
          queryById: "/zhanglaprocedure/zhanglaProcedure/queryById"
        }
      }
    },
    computed: {
