package com.trtm.iot.lowstrain_m.vo;
 ...
 */
@Data
@ApiModel(value="lowstrain_mPage对象", description="低应变主表")
public class LowstrainMPage {
	...
	@ExcelCollection(name="低应变子表")
	@ApiModelProperty(value = "低应变子表")
	private List<LowstrainS> lowstrainSList;
