package com.trtm.iot.swbhzcailiaoStatistics.entity;
 ...
 */
@Data
@TableName("bhz_sw_cailiao_statistics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_sw_cailiao_statistics对象", description="bhz_sw_cailiao_statistics")
public class BhzSwCailiaoStatistics implements Serializable {
