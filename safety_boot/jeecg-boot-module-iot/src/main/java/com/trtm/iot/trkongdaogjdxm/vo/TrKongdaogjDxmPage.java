package com.trtm.iot.trkongdaogjdxm.vo;
 ...
 */
@Data
@ApiModel(value="tr_kongdaogj_dxmPage对象", description="孔道灌浆（定性检测）主表")
public class TrKongdaogjDxmPage {
	...
	@ExcelCollection(name="孔道灌浆（定性检测）孔道信息表")
	@ApiModelProperty(value = "孔道灌浆（定性检测）孔道信息表")
	private List<TrKongdaogjDxkdxx> trKongdaogjDxkdxxList;
	@ExcelCollection(name="孔道灌浆（定性检测）子表")
	@ApiModelProperty(value = "孔道灌浆（定性检测）子表")
	private List<TrKongdaogjDxs> trKongdaogjDxsList;
