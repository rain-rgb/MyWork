package com.trtm.iot.devicemixpilerealdata.entity;
 ...
 */
@Data
@TableName("device_mixpile_realdata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_mixpile_realdata对象", description="device_mixpile_realdata")
public class DeviceMixpileRealdata implements Serializable {
    ...
    private java.lang.String mileage;// 里程桩号
    private java.lang.String piletype;
    private java.lang.String press;
    private java.lang.String flowmeter;
    private java.lang.String permgrout;//每米管浆量
    private java.lang.Integer gzcount;//1初搅；2复搅
