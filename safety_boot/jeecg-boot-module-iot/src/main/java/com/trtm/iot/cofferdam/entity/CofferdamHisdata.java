 ...
 */
@Data
@TableName("cofferdam_hisdata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="cofferdam_hisdata对象", description="cofferdam_hisdata")
public class CofferdamHisdata implements Serializable {
    private static final long serialVersionUID = 1L;

	/**围堰历史数据id*/
	@TableId(type = IdType.AUTO)
    @ApiModelProperty(value = "围堰历史数据id")
	...
	/**上传数据*/
	@Excel(name = "上传数据", width = 15)
    @ApiModelProperty(value = "上传数据")
