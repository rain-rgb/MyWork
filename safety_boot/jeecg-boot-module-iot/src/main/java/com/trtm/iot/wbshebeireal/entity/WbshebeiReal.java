package com.trtm.iot.wbshebeireal.entity;
 ...
 */
@Data
@TableName("wbshebei_real")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wbshebei_real对象", description="电子锁实时数据表")
public class WbshebeiReal implements Serializable {
	...
	/**是否发送信息0发送消息1为没发送消息*/
	@Excel(name = "是否发送信息0发送消息1为没发送消息", width = 15)
    @ApiModelProperty(value = "是否发送信息0发送消息1为没发送消息")
    private java.lang.String sffs;
	/**是否报警0为报警1为不报警*/
	@Excel(name = "是否报警0为报警1为不报警", width = 15)
    @ApiModelProperty(value = "是否报警0为报警1为不报警")
