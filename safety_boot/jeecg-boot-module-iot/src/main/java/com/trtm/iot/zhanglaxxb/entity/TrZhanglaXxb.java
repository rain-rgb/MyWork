 ...
 */
@Data
@TableName("tr_zhangla_xxb")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tr_zhangla_xxb对象", description="张拉信息表")
public class TrZhanglaXxb implements Serializable {
