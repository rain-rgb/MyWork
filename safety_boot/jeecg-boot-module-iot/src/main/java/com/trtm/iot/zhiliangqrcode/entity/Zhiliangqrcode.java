package com.trtm.iot.zhiliangqrcode.entity;
 ...
 */
@Data
@TableName("zhiliangqrcode")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="zhiliangqrcode对象", description="zhiliangqrcode")
public class Zhiliangqrcode implements Serializable {
