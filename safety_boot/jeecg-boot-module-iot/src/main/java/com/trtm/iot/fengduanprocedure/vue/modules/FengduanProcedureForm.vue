    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="封端状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['status']" placeholder="请输入封端状态" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/fengduanprocedure/fengduanProcedure/add",
          edit: "/fengduanprocedure/fengduanProcedure/edit",
          queryById: "/fengduanprocedure/fengduanProcedure/queryById"
        }
      }
    },
    computed: {
