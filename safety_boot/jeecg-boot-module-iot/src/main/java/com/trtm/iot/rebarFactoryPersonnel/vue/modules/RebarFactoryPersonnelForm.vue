  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="任务编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="factoryId">
              <a-input v-model="model.factoryId" placeholder="请输入任务编号"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
<script>
  ...
  export default {
    name: 'RebarFactoryPersonnelForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/rebarFactoryPersonnel/rebarFactoryPersonnel/add",
          edit: "/rebarFactoryPersonnel/rebarFactoryPersonnel/edit",
          queryById: "/rebarFactoryPersonnel/rebarFactoryPersonnel/queryById"
        }
      }
    },
    computed: {
