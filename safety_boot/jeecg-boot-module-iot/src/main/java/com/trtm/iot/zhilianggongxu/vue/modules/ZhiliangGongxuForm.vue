        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="唯一值" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['uuid', validatorRules.uuid]" placeholder="请输入唯一值"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="工序序号(工序字典值)" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['xuhao']" placeholder="请输入工序序号(工序字典值)" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="0 未完成  1 进行中   2已完成" :labelCol="labelCol" :wrapperCol="wrapperCol">
