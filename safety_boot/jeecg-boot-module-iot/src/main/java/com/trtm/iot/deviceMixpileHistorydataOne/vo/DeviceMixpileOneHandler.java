...
public class DeviceMixpileOneHandler implements Serializable {
    ...
    private java.lang.Integer gzcount;//搅拌次数

    @TableField(exist = false)
    private List<DeviceMixpileOneHandlerPage> deviceMixpileOneHandlerPages;
