...
<script>
  ...
  export default {
    name: 'DevicePowerStatusdataForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/devicepowerstatusdata/devicePowerStatusdata/add",
          edit: "/devicepowerstatusdata/devicePowerStatusdata/edit",
          queryById: "/devicepowerstatusdata/devicePowerStatusdata/queryById"
        }
      }
    },
    computed: {
