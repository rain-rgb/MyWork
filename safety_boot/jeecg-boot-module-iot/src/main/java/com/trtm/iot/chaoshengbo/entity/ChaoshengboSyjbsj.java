 ...
 */
@Data
@TableName("chaoshengbo_syjbsjview")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="chaoshengbo_syjbsj对象", description="chaoshengbo_syjbsj")
public class ChaoshengboSyjbsj implements Serializable {
    ...
    private java.lang.Integer ifinish;

    @TableField(exist = false)
    private String pdfUrl;

    public String getPdfUrl() {
        return "http://121.40.163.88:8084/CATDPS/TestingMachineController.do?getReportPdfUrl&sampleNo="+this.liushuihao;
    }

    public void setPdfUrl(String pdfUrl) {
        this.pdfUrl = "http://121.40.163.88:8084/CATDPS/TestingMachineController.do?getReportPdfUrl&sampleNo="+this.liushuihao;;
    }
}
