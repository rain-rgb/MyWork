  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      ...
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24" >
            <a-form-model-item label="json文件唯一标识" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="uuid">
              <a-input v-model="model.uuid" placeholder="请输入json文件唯一标识" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
            <a-form-model-item label="json文件唯一标识" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="uuid">
          ...
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="detectparamno">
              <a-input v-model="model.detectparamno" placeholder="请输入保留字段" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="detectparamno">
          ...
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="programname">
              <a-input v-model="model.programname" placeholder="请输入保留字段" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="programname">
          ...
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="pushprojectname">
              <a-input v-model="model.pushprojectname" placeholder="请输入保留字段" ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
            <a-form-model-item label="保留字段" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="pushprojectname">
