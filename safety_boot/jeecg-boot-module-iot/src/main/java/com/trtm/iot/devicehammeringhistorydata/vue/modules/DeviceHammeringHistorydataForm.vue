...
<script>
  ...
  export default {
    name: 'DeviceHammeringHistorydataForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/devicehammeringhistorydata/deviceHammeringHistorydata/add",
          edit: "/devicehammeringhistorydata/deviceHammeringHistorydata/edit",
          queryById: "/devicehammeringhistorydata/deviceHammeringHistorydata/queryById"
        }
      }
    },
    computed: {
