package com.trtm.iot.devicetiebeamrealdata.entity;
 ...
 */
@Data
@TableName("device_tiebeam_realdata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_tiebeam_realdata对象", description="提梁机实时数据信息表")
public class DeviceTiebeamRealdata implements Serializable {
