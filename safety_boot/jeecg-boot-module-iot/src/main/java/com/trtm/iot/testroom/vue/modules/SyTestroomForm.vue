    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="类型" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="roomType">
              <a-input v-model="model.roomType" placeholder="请输入类型"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="设备列表" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="shebeis">
              <a-input v-model="model.shebeis" placeholder="请输入设备列表"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="人员列表" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="renyuans">
              <a-input v-model="model.renyuans" placeholder="请输入人员列表"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
