package com.trtm.iot.bhzSwJipeiFanwei.entity;
 ...
 */
@Data
@TableName("bhz_sw_jipei_fanwei")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="bhz_sw_jipei_fanwei对象", description="bhz_sw_jipei_fanwei")
public class BhzSwJipeiFanwei implements Serializable {
	...
	/**creattime*/
	@Excel(name = "creattime", width = 15, format = "yyyy-MM-dd")
