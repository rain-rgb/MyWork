 ...
 * @Version: V1.0
 */
@ApiModel(value="company_order_management对象", description="订单管理")
@Data
@TableName("company_order_management")
public class CompanyOrderManagement implements Serializable {
