package com.trtm.iot.device_concrete_historydata.entity;
 ...
 */
@Data
@TableName("device_concrete_historydata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_concrete_historydata对象", description="混凝土成熟度监测历史表")
public class DeviceConcreteHistorydata implements Serializable {
