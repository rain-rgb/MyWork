package com.trtm.iot.lqbhzrecipe.vo;
 ...
 */
@Data
@ApiModel(value="bhz_lq recipePage对象", description="沥青拌合站理论配合比主表")
public class BhzLqRecipePage {
    /**id*/
    ...
    private List<BhzLqPhbZibiao> bhzLqPhbZibiaoList;
}
