    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="最新数据时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="datatime">
              <j-date placeholder="请选择最新数据时间" v-model="model.datatime"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="最新数据" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="datajson">
              <a-input v-model="model.datajson" placeholder="请输入最新数据"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/cofferdam/cofferdamRealdata/add",
          edit: "/cofferdam/cofferdamRealdata/edit",
          queryById: "/cofferdam/cofferdamRealdata/queryById"
        }
      }
    },
    computed: {
