package com.trtm.iot.deviceLargeOverHandler.entity;
 ...
 */
@Data
@TableName("device_large_over_handler")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_large_over_handler对象", description="device_large_over_handler")
public class DeviceLargeOverHandler implements Serializable {
	...
	/**对应试验试主表SYJID*/
	@Excel(name = "对应试验试主表SYJID", width = 15)
    @ApiModelProperty(value = "对应试验试主表SYJID")
	...
	/**超标状态：0为未处理，10为施工方已处理，20为监理方已处理 30驳回*/
	@Excel(name = "超标状态：0为未处理，10为施工方已处理，20为监理方已处理 30驳回", width = 15)
    @ApiModelProperty(value = "超标状态：0为未处理，10为施工方已处理，20为监理方已处理 30驳回")
