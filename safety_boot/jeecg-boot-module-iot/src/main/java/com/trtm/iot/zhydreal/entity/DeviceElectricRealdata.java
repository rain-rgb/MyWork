package com.trtm.iot.zhydreal.entity;
 ...
 */
@Data
@TableName("device_electric_realdata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_electric_realdata对象", description="智慧用电实时数据表")
public class DeviceElectricRealdata implements Serializable {
