        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="蒸养状态1" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['status1']" placeholder="请输入蒸养状态1" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="蒸养状态2" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['status2']" placeholder="请输入蒸养状态2" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/zhengyang/zhengyangProcedure/add",
          edit: "/zhengyang/zhengyangProcedure/edit",
          queryById: "/zhengyang/zhengyangProcedure/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'uuid','status1','status2','starttime','endtime','temperature','humidity','createBy','createTime'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'uuid','status1','status2','starttime','endtime','temperature','humidity','createBy','createTime'))
      },
    }
  }
</script>