 ...
 */
@Data
@TableName("device_bridge_historydata")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_bridge_historydata对象", description="device_bridge_historydata")
public class DeviceBridgeHistorydata implements Serializable {
