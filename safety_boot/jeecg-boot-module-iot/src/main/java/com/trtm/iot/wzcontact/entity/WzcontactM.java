 ...
 */
@Data
@TableName("wzcontact_m")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wzcontact_m对象", description="wzcontact_m")
public class WzcontactM implements Serializable {
    ...
    private java.lang.Integer contractNumber;
	/**签订日期*/
	...
	/**履约进度，1、正在履约；2、已退场，已封账；3、已退场，未封账。*/
	@Excel(name = "履约进度", width = 15)
    @ApiModelProperty(value = "履约进度 ")
