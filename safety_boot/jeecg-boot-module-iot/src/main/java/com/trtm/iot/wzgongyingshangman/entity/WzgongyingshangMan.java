package com.trtm.iot.wzgongyingshangman.entity;
 ...
 */
@Data
@TableName("wzgongyingshang_man")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wzgongyingshang_man对象", description="wzgongyingshang_man")
public class WzgongyingshangMan implements Serializable {
