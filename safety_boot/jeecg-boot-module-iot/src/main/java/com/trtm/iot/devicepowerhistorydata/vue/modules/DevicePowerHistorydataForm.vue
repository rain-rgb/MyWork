...
<script>
  ...
  export default {
    name: 'DevicePowerHistorydataForm',
    components: {
    },
    props: {
      //表单禁用
    ...
    data () {
      return {
        ...
        url: {
          add: "/devicepowerhistorydata/devicePowerHistorydata/add",
          edit: "/devicepowerhistorydata/devicePowerHistorydata/edit",
          queryById: "/devicepowerhistorydata/devicePowerHistorydata/queryById"
        }
      }
    },
    computed: {
