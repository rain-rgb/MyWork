 ...
 */
@Data
@TableName("device_piplewall_one_real")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_piplewall_one_real对象", description="device_piplewall_one_real")
public class DevicePiplewallOneReal implements Serializable {
