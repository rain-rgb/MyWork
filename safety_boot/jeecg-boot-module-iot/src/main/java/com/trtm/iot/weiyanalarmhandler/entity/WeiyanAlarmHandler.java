package com.trtm.iot.weiyanalarmhandler.entity;
 ...
 */
@Data
@TableName("weiyan_alarm_handler")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="weiyan_alarm_handler对象", description="监控量测报警处置表")
public class WeiyanAlarmHandler implements Serializable {
	...
	/**处置信息*/
	@Excel(name = "处置信息", width = 15)
    @ApiModelProperty(value = "处置信息")
    private java.lang.String dispositionInformatio;
	/**问题原因*/
