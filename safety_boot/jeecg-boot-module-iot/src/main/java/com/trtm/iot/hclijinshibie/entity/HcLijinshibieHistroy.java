 ...
 */
@Data
@TableName("hc_lijinshibie_histroy")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="hc_lijinshibie_histroy对象", description="hc_lijinshibie_histroy")
public class HcLijinshibieHistroy implements Serializable {
    ...
    private HcTfysworkareaOverHandler handle;
}
