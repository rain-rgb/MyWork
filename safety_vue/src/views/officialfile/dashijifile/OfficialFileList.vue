<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="主题类型">
              <j-dict-select-tag placeholder="请选择主题类型" v-model="queryParam.topictype" dictCode="topictype"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="来文日期时间">
              <j-date placeholder="开始日期" v-model="queryParam.filetime_begin" :showTime="true"
                      dateFormat="YYYY-MM-DD HH:mm:ss"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="">
              <j-date placeholder="结束日期" v-model="queryParam.filetime_end" :showTime="true"
                      dateFormat="YYYY-MM-DD HH:mm:ss"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" v-has="'shangjifile:dc'" @click="handleExportXls('公文信息表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'shangjifile:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/officialfile/officialFile/list6",
