...
<!--          </a-col>-->
          <a-col :span="24">
            <a-form-item label="公文添加" :labelCol="labelCol" :wrapperCol="wrapperCol">
...
<!--          </a-col>-->
          <a-col :span="24">
            <a-form-item label="来文日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择来文日期" v-decorator="['filetime']" :trigger-change="true" style="width: 100%" date-format="YYYY-MM-DD HH:mm:ss"/>
            </a-form-item>
          </a-col>
<!--          <a-col :span="24">-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/officialfile/officialFile/add4",
