    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
            ...
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-item label="名称">
                  <a-input placeholder="请输入名称" v-model="queryParam.componentName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :span="8">
              ...
              <a-col :span="8">
                <a-form-item label="构件类型">
                  <j-dict-select-tag placeholder="请选择" v-model="queryParam.componentType"
                    dictCode="component_type"></j-dict-select-tag>
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                  ...
                  <a-button type="primary" icon="download" @click="handleExportXls('构件配料管理')"
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button @click="handleAdd" type="primary" icon="plus">添加构件</a-button>
        ...
        <!-- 右侧的APP权限配置 -->
        <!-- <user-role-app-modal ref="modalForm3"></user-role-app-modal> -->
        <!-- <user-role-modal-app ref="modalForm4"></user-role-modal-app> -->
        <!-- 右侧的角色权限配置 -->
    ...
    <a-col :md="rightColMd" :sm="24">
      <a-card :bordered="false">
        ...
        <div class="table-operator" :md="24" :sm="24">
          <a-button @click="handleAdd2" type="primary" icon="plus" style="margin-top: 16px">添加材料</a-button>
        ...
        <div>
          ...
          <a-table ref="table2" bordered size="middle" rowKey="materialNo" :columns="columns2" :dataSource="dataSource2"
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <a-dropdown>
                ...
                <a-menu slot="overlay">
                  <a-menu-item>
                    <a-popconfirm title="确定删除吗?" @confirm="() => handleDelete2(record.materialId)">
                      <a>删除</a>
                    </a-popconfirm>
                  </a-menu-item>
                </a-menu>
        ...
        <martical-modal ref="modalForm2" @ok="modalFormOk2" :currentRoleId="currentRoleId"></martical-modal>
...
import IngredientManagementAddEdit from './modules/IngredientManagementAddEdit'
import marticalModal from './modules/marticalModalAddEdit'
import { filterObj } from '@/utils/util'
// import UserRoleModal from './modules/UserRoleModal'
// import UserRoleAppModal from './modules/UserRoleAppModal'
import moment from 'moment'
// import UserRoleModalApp from '@views/system/modules/UserRoleModalApp'

export default {
  name: 'IngredientManagement',//构件配料管理
  mixins: [JeecgListMixin],
  components: {
    IngredientManagementAddEdit,
    marticalModal,
    // UserRoleAppModal,
    // UserRoleModal,
    // SelectUserModal,
  ...
  data() {
    return {
      ...
      url: {
        ...
        list2: "/rebarComponent/rebarComponent/queryMaterialByComponentId",
        delete2: '/rebarComponent/rebarComponent/deleteByComponentIdAndMaterialId',
      },
      columns2: [{
        title: '材料编号',
        align: 'center',
  ...
  methods: {
    ...
    loadData2(arg) {
      ...
      params.componentId = this.currentRoleId
      this.loading2 = true
    ...
    handleDelete2: function (id) {
      ...
      var that = this
      deleteAction(that.url.delete2, { componentId: this.currentRoleId, materialId: id }).then((res) => {
        if (res.success) {
    ...
    handlePerssion1(roleId) {
      console.log(roleId);
      console.log("调用")
      this.$refs.modalForm3.show(roleId)
    },
    handlePerssion2(roleId) {
      console.log(roleId);
      console.log("调用")
      this.$refs.modalForm4.show(roleId)
    },
  }
}
</script>
