  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
<!--          <a-col :span="24">-->
<!--            <a-form-model-item label="上传时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="gatherdate">-->
<!--              <j-date placeholder="请选择上传时间" v-model="model.gatherdate"  style="width: 100%" />-->
<!--            </a-form-model-item>-->
<!--          </a-col>-->
<!--          <a-col :span="24">-->
