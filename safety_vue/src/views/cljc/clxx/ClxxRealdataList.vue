<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" v-has="'clxx:add'" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'clxx:dc'" icon="download" @click="handleExportXls('车辆信息实时数据表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'clxx:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a  v-has="'clxx:edit'" @click="handleEdit(record)">编辑卡号|</a>
...
<!--              </a-menu-item>-->
    ...
    <front-device-historydata-modal ref="modalForm1" @ok="modalFormOk"></front-device-historydata-modal>
  </a-card>
</template>
...
<script>
  ...
  import FrontDeviceHistorydataModal from './modules/FrontDeviceHistorydataModal__Style#Drawer'

  export default {
    name: 'ClxxRealdataList',
    ...
    methods: {
      ...
      handleEdit: function (record1) {
        console.log(record1)
        this.$refs.modalForm1.edit(record1);
