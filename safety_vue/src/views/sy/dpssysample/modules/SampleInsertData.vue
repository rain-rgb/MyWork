  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="样品类型" :labelCol="labelCol" :wrapperCol="wrapperCol" :rules="[{ required: true, message: '样品类型不能为空' }]" prop="titCode">
          ...
          <a-col :span="15" v-show="model.titCode=='1402'">
          ...
          <a-col :span="9" v-show="model.titCode=='1402'">
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        add: '/sydpssysample/syDpsSySample/insertDateBySampleno',
    ...
    submitForm() {
      ...
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          postAction('/sydpssysample/syDpsSySample/saveOrUpdate', this.model).then((res) => {
            if (res.success) {
