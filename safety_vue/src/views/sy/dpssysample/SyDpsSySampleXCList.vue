<template>
  <a-card :bordered="false">
    ...
    <sy-dps-sy-sample-x-c-modal ref="modalForm" @ok="modalFormOk"></sy-dps-sy-sample-x-c-modal>
...
import SyDpsSySampleXCModal from './modules/SyDpsSySampleXCModal'
...
export default {
  name: 'SyDpsSySampleXCList',
  mixins: [JeecgListMixin, mixinDevice],
  components: {
    SyDpsSySampleXCModal,
    SampleCopyDate,
    InsertData,
