  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/FormToPrint/dpsJcTestitemtype/add",
          edit: "/FormToPrint/dpsJcTestitemtype/edit",
          queryById: "/FormToPrint/dpsJcTestitemtype/queryById"
        }
      }
    },
    computed: {
