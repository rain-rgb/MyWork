        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="4" :lg="7" :md="8" :sm="24">
            <a-form-item label="取样人">
              <a-input placeholder="" v-model="queryParam.quyangren"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="5" :lg="7" :md="8" :sm="24">
            <a-form-item label="取样时间">
              <j-date
                placeholder=""
                v-model="queryParam.quyangshijian"
                :showTime="true"
          ...
          <a-col :xl="5" :lg="7" :md="8" :sm="24">
            <a-form-item label="取样状态">
              <a-radio-group name="radioGroup" :default-value="1"  v-model="queryParam.quyangzhuangtai">
                <a-radio :value="1" >全部</a-radio>
                <a-radio :value="2" >未取样</a-radio>
                <a-radio :value="3" >已取样</a-radio>
              </a-radio-group>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row>
          <a-col span="21">
            <span class="table-page-search-submitButtons">
              <a-button @click="entrustAdd" type="primary">收样</a-button>
            </span>
          </a-col>
          <a-col span="3">
            <span class="table-page-search-submitButtons">
