<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'hyl:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'hyl:dc'" @click="handleExportXls('水稳主表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl"
                @change="handleImportExcel">
        <a-button type="primary" v-has="'hyl:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a  v-has="'hyl:edit'" @click="handleEdit(record)">编辑</a>
...
<!--          <a-divider type="vertical"/>-->
    ...
    <HylytjModal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
import HylytjModal from './modules/HylytjModal'
