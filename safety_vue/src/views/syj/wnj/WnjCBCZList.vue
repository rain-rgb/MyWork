      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
             <a-menu-item v-has="'syjwn:cz'" v-if="record.syjOverHandler.overproofStatus == '0'||record.syjOverHandler.overproofStatus == '30'">
                <a @click="showmadelchuzhi(record.syjid,1)">处置</a>
              </a-menu-item>
              <a-menu-item v-has="'syjwn:sh'">
                <a @click="showmadelshenhe(record.syjid,1)" v-if="record.syjOverHandler.overproofStatus == '10'">审核</a>
              </a-menu-item>
              <a-menu-item v-has="'syjwn:bh'" v-if="record.syjOverHandler.overproofStatus == '10'">
...
import ChuZhi from '@views/syj/wnj/czsh/ChuZhi'
import ShenHe from '@views/syj/wnj/czsh/ShenHe'
import BoHui from '@views/syj/wnj/czsh/BoHui'
export default {
  name: "WnjCBCZList",
  ...
  methods: {
    ...
    showModal:function (id){
      this.visible=true;
      this.id=id;
      // console.log( this.visible,this.id)
    },
    shebeiList:function (){
