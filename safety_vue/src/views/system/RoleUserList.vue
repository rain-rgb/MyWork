    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          ...
          <a-button type="primary" icon="download" @click="handleExportXls('角色管理')"
            >导出</a-button
          >
        </div>
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <a-dropdown>
                ...
                <a-menu slot="overlay">
                  ...
                  <a-menu-item>
                    <a @click="handlePerssion1(record.id)">APP授权</a>
                  </a-menu-item>
                  <a-menu-item>
                    <a @click="handlePerssion2(record.id)">微信小程序授权</a>
                  </a-menu-item>
                  <a-menu-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete2: function (id) {
      ...
      var that = this;
      deleteAction(that.url.delete2, { roleId: this.currentRoleId, userId: id }).then(
        (res) => {
          if (res.success) {
