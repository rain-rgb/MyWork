<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button @click="handleAdd" v-has="'renwudansh:add'" type="primary" icon="plus">新增任务单</a-button>
      <a-button @click="printXls" v-has="'renwudansh:print'" type="primary" icon="printer">打印</a-button>
      <a-button  v-has="'renwudansh:dc'" type="primary" icon="download" @click="handleExportXls('任务单浇筑令')">导出</a-button>
      <a-upload name="file" v-has="'renwudansh:dr'" :showUploadList="false" :multiple="false" :headers="tokenHeader"
    ...
    <div>
      ...
      >
        ...
        <span slot="status" slot-scope="status, record">
           <a-tag color="grey" v-if="record.status==0 && (record.begtim < getRecentDay_Date(-3))">已过期</a-tag>
          <a-tag color="red" v-if="record.status==0 && !(record.begtim < getRecentDay_Date(-3)) ">未审核</a-tag>
          <a-tag color="green" v-if="record.status==1">已审核</a-tag>
           <a-tag color="yellwo" v-if="record.status==3">未通过</a-tag>
        </span>
...
<!--          <a-divider type="vertical"/>-->
          <a v-if="!(record.begtim < getRecentDay_Date(-3))" @click="showModal(record.id)">审核</a>
          <a-divider v-if="!(record.begtim < getRecentDay_Date(-3))" type="vertical"/>
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'renwudansh:edit'">
              <a @click="handleEdit(record)">编辑</a>
              </a-menu-item>
              <a-menu-item v-has="'renwudansh:del'">
    ...
    <BhzrenwudanShenHe :flag="visible" :id="id" @change="change"></BhzrenwudanShenHe>
...
import BhzrenwudanModal from './modules/BhzrenwudanSHModal'
import JSuperQuery from '@/components/jeecg/JSuperQuery.vue'
import  BhzrenwudanShenHe from './BhzrenwudanShenHe'

export default {
  name: 'BhzrenwudanSHList',
