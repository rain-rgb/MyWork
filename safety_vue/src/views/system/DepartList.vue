        ...
        <a-tab-pane tab="基本信息" key="1" >
          <a-card :bordered="false" v-if="selectedKeys.length>0">
            <a-form-model ref="form" :model="model" :rules="validatorRules">
              ...
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="项目全称/简称">
                <a-input placeholder="请输入项目全称/简称" v-model="model.departNameAbbr" />
              </a-form-model-item>
              <a-form-model-item  :labelCol="labelCol" :wrapperCol="wrapperCol"  label="地址">
                <a-input placeholder="请输入地址" v-model="model.address"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="监理单位">
                <a-input placeholder="请输入监理单位" v-model="model.supervisionUnit"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="施工单位">
                <a-input placeholder="请输入施工单位" v-model="model.constructionUnit"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="备注">
                <a-textarea placeholder="请输入备注" v-model="model.memo"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="projectid">
                <a-input placeholder="请输入关联projectid" v-model="model.projectid"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="sectionid">
                <a-input placeholder="请输入关联sectionid" v-model="model.sectionid"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="组织机构id">
                <a-input disabled="true" v-model="model.id"/>
              </a-form-model-item>
              <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="上级id">
                <a-input disabled="true" v-model="model.parentId"/>
              </a-form-model-item>
            </a-form-model>
