  ...
  methods: {
    ...
    changepiciRS1(selectedValue) {
      for(let item of this.piciList1){
        if (item.value == selectedValue ){
          ...
          console.log("检验批选择 this.model.piciALL1--------",this.model.piciALL1 )
    ...
    validatepici1hege(rule, value, callback) {
      ...
      if (!value) {
        ...
        console.log('请选择合格检验批! ----------','piciALL'+str.substring(4,str.length))
         console.log('请选择合格检验批! ----------', form.getFieldValue('piciALL'+str.substring(4,str.length)))
