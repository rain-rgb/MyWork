              ...
              <a-col :span="1">
                <a-form-item>
                  <j-search-select-tag
                    ...
                    style="width: 150%"
                    v-decorator="['pici3', validatorRules.pici3]"
              ...
              <a-col :span="1">
                <a-form-item>
                  <j-search-select-tag
                    ...
                    style="width: 150%"
                    v-decorator="['pici12', validatorRules.pici12]"
              ...
              <a-col :span="1">
                <a-form-item>
                  <j-search-select-tag
                    ...
                    style="width: 150%"
                    v-decorator="['pici8', validatorRules.pici8]"
              ...
              <a-col :span="1">
                <a-form-item>
                  <j-search-select-tag
                    ...
                    style="width: 150%"
                    v-decorator="['pici9', validatorRules.pici9]"
              ...
              <a-col :span="1">
                <a-form-item>
                  <j-search-select-tag
                    ...
                    v-decorator="['pici11', validatorRules.pici11]"
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        listpld: "/system/shigongphb/listpld47s",
      },
      nameList: [
        "材料",
        "材料名称",
  ...
  methods: {
    ...
    validatepici1(rule, value, callback) {
      if (!value) {
        // console.log('validatepici1-rule', rule)
        // console.log('validatepici1-value', value)
        // console.log('validatepici1-callback', callback)
