  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="所在单位" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="danwei">
          <a-input placeholder="请输入所在单位" v-model="model.danwei" />
        </a-form-model-item>
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          password: [{required: true,pattern:/^(?=.*[a-z]).{8,}$/,message: '密码由8位数字、字母组成!'},
