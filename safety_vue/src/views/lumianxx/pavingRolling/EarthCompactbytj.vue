...
<!--              &lt;!&ndash; <a-button type="primary" @click="searchQueryHandle" icon="search"-->
<!--                >查询</a-button-->
<!--              > &ndash;&gt;-->
<!--              <a-button-->
<!--                type="primary"-->
...
<!--    </div>-->
    ...
    <div>
      ...
      >
        ...
        <span slot="StationTags" slot-scope="StationTags, record">
          <div v-if="record.startstation != 0">
            {{ record.startstation | getStation }}
          </div>
          <div v-else>K0+000</div>
          <div>-</div>
          <div v-if="record.endstation != 0">{{ record.endstation | getStation }}</div>
          <div v-else>K0+000</div>
        </span>
    ...
    <tfyschuzhi :flag="flag" :id="syjid" @change="change"></tfyschuzhi>
...
import reportDetail from "@views/lumianxx/modules/reportDetail.vue";
import Vue from "vue";
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        list: "/hc_tfysworkarea/hcTfysworkarea/listbytj",
  ...
  methods: {
    ...
    showModel(array) {
      ...
      this.$refs.reportDetail.title = "施工区域报告";
      // this.$refs.PavingResultDetail.projectid = array.projectid;
      this.$refs.reportDetail.call(array);
    },
