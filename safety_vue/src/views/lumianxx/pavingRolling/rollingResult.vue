    ...
    <div>
      ...
      >
        ...
        <span slot="yajiangji" slot-scope="yajiangji, record">
          ...
          <a class="ant-dropdown-link" @click="showResult(record.id)">施工成果图</a>
        </span>
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            <a class="ant-dropdown-link" @click="showmadel1(record.id)">详情</a>
            <!-- <a class="ant-dropdown-link">更多 <a-icon type="down" /></a> -->
            <!-- <a-menu slot="overlay">
              <a-menu-item>
                <a @click="showmadel1(record.id)">详情</a>
              </a-menu-item>
...
export default {
  ...
  methods: {
    showmadel1(syjid) {
      ...
      this.$refs.rollingResultDetail.call(syjid);
    },
    showResult(syjid) {
