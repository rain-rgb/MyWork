...
<script>
  ...
  export default {
    name: 'DeviceMixpileHistorydataForm',
    components: {
      JFormContainer,
      JDate,
    },
    ...
    data () {
      return {
        ...
        url: {
          add: "/devicemixpilehistorydata/deviceMixpileHistorydata/add",
          edit: "/devicemixpilehistorydata/deviceMixpileHistorydata/edit",
          queryById: "/devicemixpilehistorydata/deviceMixpileHistorydata/queryById"
        }
      }
    },
    computed: {
