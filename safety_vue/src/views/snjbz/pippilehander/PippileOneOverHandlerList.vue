<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('pippile_one_over_handler')">导出</a-button>
    ...
    <pippile-one-over-handler-modal ref="modalForm" @ok="modalFormOk"></pippile-one-over-handler-modal>
  </a-card>
</template>
...
<script>
  ...
  import PippileOneOverHandlerModal from './modules/PippileOneOverHandlerModal'

  export default {
    name: 'PippileOneOverHandlerList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      PippileOneOverHandlerModal
    },
    data () {
      return {
        description: 'pippile_one_over_handler管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          ...
          delete: "/pippileOneOverHandler/pippileOneOverHandler/delete",
          deleteBatch: "/pippileOneOverHandler/pippileOneOverHandler/deleteBatch",
          exportXlsUrl: "/pippileOneOverHandler/pippileOneOverHandler/exportXls",
          importExcelUrl: "pippileOneOverHandler/pippileOneOverHandler/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'baseid',text:'对应成桩记录主表id'})
        ...
        fieldList.push({type:'string',value:'remark',text:'备注(驳回)'})
