<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'mixpilehistoryonecbcl:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'mixpilehistoryonecbcl:dc'" @click="handleExportXls2h('搅拌桩成桩记录信息表')">导出</a-button>
      <a-button type="primary" icon="download" @click="print1">超标导出</a-button>
      <a-upload name="file"  :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'mixpilehistoryonecbcl:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
         <a v-has="'mixpilehistoryonecbcl:edit'" @click="handleEdit(record)">编辑</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'snjbz:sh'">
                ...
                <a-menu-item>
                  <a-popconfirm v-has="'mixpilehistoryonecbcl:del'" title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                   <a>删除</a>
                  </a-popconfirm>
                 </a-menu-item>
            </a-menu>
...
<!--          </a-dropdown>-->
    ...
    <device-mixpile-historydata-one-c-b-modal ref="modalForm" @ok="modalFormOk"></device-mixpile-historydata-one-c-b-modal>
  </a-card>
</template>
...
<script>
  ...
  import DeviceMixpileHistorydataOneCBModal from '@views/snjbz/devicemixpilehistorydataone/modules/DeviceMixpileHistorydataOneCBModal'
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/deviceMixpileHistorydataOne/deviceMixpileHistorydataOne/cbcllist",
          ...
          printUrl: "jmreport/view/908993187030069248",
