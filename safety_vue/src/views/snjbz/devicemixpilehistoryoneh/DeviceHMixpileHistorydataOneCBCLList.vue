<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'mixpilehistoryonehcbcl:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'mixpilehistoryonehcbcl:dc'" @click="handleExportXls2h('搅拌桩成桩记录信息表')">导出</a-button>
      <a-upload name="file"  :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'mixpilehistoryonehcbcl:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
         <a v-has="'mixpilehistoryonehcbcl:edit'" @click="handleEdit(record)">编辑</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item v-has="'snjbz:czh'">
                <a @click="showmadel1(record)">处置</a>
              </a-menu-item>
              <a-menu-item v-has="'snjbz:bhh'">
                <a @click="showmadel2(record)">驳回</a>
              </a-menu-item>
              <a-menu-item v-has="'snjbz:shh'">
                <a @click="showmadel(record)">审核</a>
              </a-menu-item>

                <a-menu-item>
                  <a-popconfirm v-has="'mixpilehistoryonehcbcl:del'" title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                   <a>删除</a>
                  </a-popconfirm>
                 </a-menu-item>
            </a-menu>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/deviceMixpileHistorydataOne/deviceMixpileHistorydataOne/cbclhlist",
    ...
    methods: {
      showmadel: function (record) {
        if (record.handler.overproofStatus === 10) {
