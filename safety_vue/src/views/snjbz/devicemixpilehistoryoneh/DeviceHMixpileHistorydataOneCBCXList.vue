<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'mixpilehistoryonehcbcx:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'mixpilehistoryonehcbcx:dc'" @click="handleExportXls2h('搅拌桩成桩记录信息表')">导出</a-button>
      <a-upload name="file"  :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'mixpilehistoryonehcbcx:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
...
<!--      </a-dropdown>-->
    ...
    <div>
      ...
      >
        ...
        <a-tag color="red" v-if="record.chaobiaodengji === 1">不合格</a-tag>
          <a-tag color="orange" v-if="record.chaobiaodengji === null">未检测</a-tag>
        ...
        <span slot="action" slot-scope="text, record">
         <a v-has="'mixpilehistoryonehcbcx:edit'" @click="handleEdit(record)">编辑</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
<!--              <a-menu-item v-has="'snjbz:czshInfoh'">-->
...
<!--              </a-menu-item>-->
                ...
                <a-menu-item>
                  <a-popconfirm v-has="'mixpilehistoryonehcbcx:del'" title="确定删除吗?" @confirm="() => handleDelete(record.id)">
                   <a>删除</a>
                  </a-popconfirm>
                 </a-menu-item>
            </a-menu>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/deviceMixpileHistorydataOne/deviceMixpileHistorydataOne/cbcxhlist",
