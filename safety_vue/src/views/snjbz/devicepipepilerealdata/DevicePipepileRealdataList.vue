...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('device_pipepile_realdata')">导出</a-button>-->
...
<!--          <a @click="handleEdit(record)">编辑</a>-->
    ...
    <device-pipepile-realdata-modal ref="modalForm" @ok="modalFormOk"></device-pipepile-realdata-modal>
  </a-card>
</template>
...
<script>
  ...
  import DevicePipepileRealdataModal from './modules/DevicePipepileRealdataModal'
  import { getAction } from '@api/manage'
  import { usershebeiList } from '@api/api'
  import Vue from 'vue'

  export default {
    name: 'DevicePipepileRealdataList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      DevicePipepileRealdataModal
    },
    data () {
      return {
        dictOption: [],
        selectValue:'',
        description: 'device_pipepile_realdata管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/devicepipepilerealdata/devicePipepileRealdata/list",
          delete: "/devicepipepilerealdata/devicePipepileRealdata/delete",
          deleteBatch: "/devicepipepilerealdata/devicePipepileRealdata/deleteBatch",
          exportXlsUrl: "/devicepipepilerealdata/devicePipepileRealdata/exportXls",
          importExcelUrl: "devicepipepilerealdata/devicePipepileRealdata/importExcel",
