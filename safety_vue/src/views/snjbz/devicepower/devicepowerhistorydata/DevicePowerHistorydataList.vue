...
<!--      <a-button type="primary" icon="download" @click="handleExportXls('device_power_historydata')">导出</a-button>-->
...
<!--    </div>-->
    ...
    <device-power-historydata-modal ref="modalForm" @ok="modalFormOk"></device-power-historydata-modal>
  </a-card>
</template>
...
<script>
  ...
  import DevicePowerHistorydataModal from './modules/DevicePowerHistorydataModal'

  export default {
    name: 'DevicePowerHistorydataList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      DevicePowerHistorydataModal
    },
    data () {
      return {
        description: 'device_power_historydata管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/devicepowerhistorydata/devicePowerHistorydata/list",
          delete: "/devicepowerhistorydata/devicePowerHistorydata/delete",
          deleteBatch: "/devicepowerhistorydata/devicePowerHistorydata/deleteBatch",
          exportXlsUrl: "/devicepowerhistorydata/devicePowerHistorydata/exportXls",
          importExcelUrl: "devicepowerhistorydata/devicePowerHistorydata/importExcel",
