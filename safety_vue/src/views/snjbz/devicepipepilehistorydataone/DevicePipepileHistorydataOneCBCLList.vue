...
<!--      </a-dropdown>-->
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'snjgz:cz'">
                <a @click="showmadel1(record)">处置</a>
              </a-menu-item>
              <a-menu-item v-has="'snjgz:bh'">
                <a @click="showmadel2(record)">驳回</a>
              </a-menu-item>
              <a-menu-item v-has="'snjgz:sh'">
    ...
    <pippile-one-over-handler-modal ref="modalForm1" @ok="modalFormOk"></pippile-one-over-handler-modal>
  </a-card>
</template>
...
<script>
  ...
  import PippileOneOverHandlerModal from '../pippilehander/modules/PippileOneOverHandlerModal'
  export default {
    name: 'DevicePipepileHistorydataOneCBCLList',
