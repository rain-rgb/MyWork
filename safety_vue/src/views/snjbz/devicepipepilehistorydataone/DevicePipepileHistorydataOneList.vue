        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="超标查询">
              <j-dict-select-tag placeholder="请选择是否合格" v-model="queryParam.chaobiaodengji" dictCode="chaobiaodengji"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<!--       </span>-->
        ...
        <a-tag color="red" v-if="record.overproofStatus === 0">未处置</a-tag>
        <a-tag color="green" v-if="record.overproofStatus === 10">已处置</a-tag>
        <a-tag color="orange" v-if="record.overproofStatus === 20">已闭合</a-tag>
          <a-tag color="grey" v-if="record.overproofStatus === 30 ">已驳回</a-tag>
