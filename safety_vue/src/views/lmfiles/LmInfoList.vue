...
<!--              <a-menu-item>-->
<!--                <a @click="swUpload">水温文件</a>-->
<!--              </a-menu-item>-->
<!--              <a-menu-item>-->
<!--                <a @click="lqUpload">沥青文件</a>-->
<!--              </a-menu-item>-->
            </a-menu>
          </a-dropdown>
        </span>
    ...
    <lm-info-modal ref="modalForm" @ok="modalFormOk"></lm-info-modal>
  </a-card>
</template>
...
import LmInfoModal from './modules/LmInfoModal'
