    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input
            placeholder="请输入计划名称"
            v-decorator.trim="['planName', validatorRules.username]"
            :readOnly="!!model.id"
          />
        </a-form-item>
        ...
        <a-form-item label="分部分项" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-tree-select
                v-decorator.trim="[ 'projectNo', validatorRules.realname]"
        ...
        <a-form-item label="类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select label-in-value :default-value="{}" @change="handleChange">
            <a-select-option v-for="(item, index) in reslut" :key="index" v-decorator.trim="[ 'type', validatorRules.realname]" >{{ item.title }}</a-select-option>
          </a-select>
        ...
        <a-form-item label="时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date :showTime="true" dateFormat="YYYY-MM-DD HH:mm:ss" v-decorator.trim="[ 'time', validatorRules.realname]" />
        </a-form-item>
        ...
        <a-form-item label="发布人" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input disabled v-decorator.trim="['uploadBy']" />
          <!-- <j-dict-select-tag  /> -->
        </a-form-item>
        <a-form-item label="文件上传" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-upload :fileType="fileType" v-decorator.trim="['uploadFilenames', validatorRules.realname]"></j-upload>
        </a-form-item>
      </a-form>
    </a-spin>
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      that.visible = true
      that.model = Object.assign({}, record) //浅拷贝
      that.$nextTick(() => {
