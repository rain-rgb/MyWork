<template>
  <a-card :bordered="false">
    ...
    <device-bridge-realdata-modal ref="modalForm" @ok="modalFormOk"></device-bridge-realdata-modal>
  </a-card>
</template>
...
<script>
  ...
  import DeviceBridgeRealdataModal from './modules/DeviceBridgeRealdataModal'

  export default {
    name: 'DeviceBridgeRealdataList',
    mixins:[JeecgListMixin, mixinDevice,handertoken],
    components: {
      DeviceBridgeRealdataModal
    },
    data () {
      return {
        description: 'device_bridge_realdata管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          list: "/jiaqiaoji/deviceBridgeRealdata/list",
          delete: "/jiaqiaoji/deviceBridgeRealdata/delete",
          deleteBatch: "/jiaqiaoji/deviceBridgeRealdata/deleteBatch",
          exportXlsUrl: "/jiaqiaoji/deviceBridgeRealdata/exportXls",
          importExcelUrl: "jiaqiaoji/deviceBridgeRealdata/importExcel",
