<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" v-has ="'jiaqiaojihistory:add'" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'jiaqiaojihistory:dc'" icon="download" @click="handleExportXls('龙门吊表信息')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'jiaqiaojihistory:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
...
<!--       </span>-->
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'jiaqiaojihistory:edit'" @click="handleEdit(record)">编辑</a>
...
<!--          <a-divider type="vertical" />-->
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'jiaqiaojihistory:del'" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/lmd/deviceCraneHistorydata/list2",
