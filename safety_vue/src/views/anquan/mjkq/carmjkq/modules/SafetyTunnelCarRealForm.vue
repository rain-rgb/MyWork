    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="进/出时间" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="enterTime">
              <a-input v-model="model.enterTime" placeholder="请输入进/出时间"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/safetyTunnelCarReal/safetyTunnelCarReal/add",
          edit: "/safetyTunnelCarReal/safetyTunnelCarReal/edit",
          queryById: "/safetyTunnelCarReal/safetyTunnelCarReal/queryById"
        }
      }
    },
    computed: {
