<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" v-has="'tiliangjireal:add'" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'tiliangjireal:dc'" @click="handleExportXls('龙门吊实时数据')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'tiliangjireal:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'tiliangjireal:edit'" @click="handleEdit(record)">编辑</a>
...
<!--          <a-divider type="vertical" />-->
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'tiliangjireal:del'" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/devicecranerealdata/deviceCraneRealdata/list3",
