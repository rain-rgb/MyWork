<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" v-has="'lmdreal:add'" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'lmdreal:dc'" icon="download" @click="handleExportXls('龙门吊实时数据')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'lmdreal:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'lmdreal:edit'" @click="handleEdit(record)">编辑</a>
