...
<!--          </a-dropdown>-->
    ...
    <zhilianggongxu-yd-modal ref="modalForm" @ok="modalFormOk"></zhilianggongxu-yd-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZhilianggongxuYdModalModal from '@views/zhiliang/zhiliangrenwudan/modules/ZhilianggongxuModal'
  import ZhilianggongxuYdModal from '@views/zhiliang/zhiliangrenwudan/modules/ZhilianggongxuYdModal'

  export default {
    name: 'ZhilianggongxuYdList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      ZhilianggongxuYdModal,
      JSuperQuery,
    },
    data () {
      return {
