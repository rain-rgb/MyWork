<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'zhiliangrwdyd:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'zhiliangrwdyd:dc'" @click="handleExportXls('任务单（制梁）表信息')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'zhiliangrwdyd:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
...
<!--        </span>-->
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleEdit(record)" v-has="'zhiliangrwdyd:edit'" >编辑</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'zhiliangrwdyd:del'" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zhiliangrenwudan/zhiliangrenwudan/ydlist",
