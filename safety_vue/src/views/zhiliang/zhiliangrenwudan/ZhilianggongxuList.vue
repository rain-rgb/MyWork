<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="请选择施工部位" >
              <JSelectDqProjName  v-model="queryParam.projgrade" ::multi="false" />
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'zlgx:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'zlgx:dc'" @click="handleExportXls('任务单（制梁）表信息')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'zlgx:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a @click="handleDetail(record)">流程</a>
...
<!--            <a-menu slot="overlay">-->
<!--              <a-menu-item>-->
<!--                <a @click="handleEdit(record)" v-has="'zlgx:edit'" >编辑</a>-->
<!--              </a-menu-item>-->
<!--              <a-menu-item>-->
<!--                <a @click="handleDetail(record)">详情</a>-->
<!--              </a-menu-item>-->
<!--              <a-menu-item v-has="'zlgx:del'" >-->
...
<!--          </a-dropdown>-->
    ...
    <zhilianggongxu-modal ref="modalForm" @ok="modalFormOk"></zhilianggongxu-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZhilianggongxuModal from '@views/zhiliang/zhiliangrenwudan/modules/ZhilianggongxuModal'
