<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'zhiliangrwdsh:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'zhiliangrwdsh:dc'" @click="handleExportXls('任务单（制梁）表信息')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'zhiliangrwdsh:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item >
                <a @click="handleEdit(record)" v-has="'zhiliangrwdsh:edit'" >编辑</a>
              </a-menu-item>
              <a-menu-item v-has="'zhiliangrwdsh:del'" >
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/zhiliangrenwudan/zhiliangrenwudan/shlist",
