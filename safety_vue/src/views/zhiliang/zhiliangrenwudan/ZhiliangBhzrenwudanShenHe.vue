  ...
  <div >
    ...
    >
      ...
      <a-form-item label="审批意见" :labelCol="labelCol" :wrapperCol="wrapperCol" centered>
        <a-input placeholder="请输入审批意见" v-model="note"></a-input>
      </a-form-item>
    </a-modal>
  </div>
</template>
<script>
  ...
  export default {
    name:'ZhiliangBhzrenwudanShenHe',
    props: ['flag','id'],
    data() {
      return {
        note:'',
        ...
        url: {
          ...
          edit:"/zhiliangrenwudan/zhiliangrenwudan/edit",
        }
      };
    },
    watch: {
    ...
    methods: {
      ...
      subcommit(){
        let param={id:this.id,status:this.approval_remarks,note:this.note}
