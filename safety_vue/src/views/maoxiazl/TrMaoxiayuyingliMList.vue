<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="4" :lg="7" :md="8" :sm="24">
            <a-form-item label="是否合格">
              <j-dict-select-tag placeholder="请选择是否合格" v-model="queryParam.overLevel"
                                 dictCode="mxzlzt"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="4" :lg="7" :md="8" :sm="24">
    ...
    <tr-maoxiayuyingli-m-modal1 ref="modalForm" @ok="modalFormOk" />
  </a-card>
</template>
...
import TrMaoxiayuyingliMModal1 from './modules/TrMaoxiayuyingliMModal1'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/trmaoxiayuyinglim/trMaoxiayuyingliM/list',
