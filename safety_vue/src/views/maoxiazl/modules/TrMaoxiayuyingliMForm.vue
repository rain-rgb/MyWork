          ...
          <a-row>
            ...
            <a-col :span="12">
              <a-form-item label="处理方式" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input
                  v-model="bhzCementOverHandler.handleWay"
                  placeholder="无"
                ></a-input>
              </a-form-item>
            </a-col>
          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="处理结果" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input
                  v-model="bhzCementOverHandler.handleResult"
                  placeholder="无"
                ></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="处理时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input
                  v-model="bhzCementOverHandler.handleTime"
                  placeholder="无"
                ></a-input>
              </a-form-item>
            </a-col>
          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="处置人" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input
                  v-model="bhzCementOverHandler.handlePerson"
                  placeholder="无"
                ></a-input>
              </a-form-item>
            </a-col>
        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="处置附件" :labelCol="labelCol1" :wrapperCol="wrapperCol1">
              <viewer :images="detailList" v-if="detailList.length>0">
                <img
  ...
  data() {
    return {
      ...
      url: {
        ...
        trMaoxiayuyingliS: {
          list: "/trmaoxiayuyinglim/trMaoxiayuyingliM/queryTrMaoxiayuyingliSByMainId",
        },
      },
      detailList: [],
      detailList1: [],
  ...
  methods: {
    ...
    editAfter() {
      ...
      if (this.model.id) {
        ...
        this.requestSubTableData1(
          this.url.trMaoxiayuyingliS.list,
          params,
          this.trMaoxiayuyingliSTable
        );
        setTimeout(() => {
          console.log(
            `this.trMaoxiayuyingliSTable===========`,
      ...
      if (this.model.trMaoxiayuyingliOverHandler) {
        this.bhzCementOverHandler = this.model.trMaoxiayuyingliOverHandler;
        ...
        .then((res) => {
          ...
          if (result) {
            if (Array.isArray(result)) {
              dataSource = result;
            } else if (Array.isArray(result.trMaoxiayuyingliSList)) {
              dataSource = result.trMaoxiayuyingliSList;
            }
          }
