...
<!--              </a-menu-item>-->
    ...
    <chu-zhi :flag="flag"  :uuid="uuid" @change="change2"></chu-zhi>
    <tr-maoxiayuyingli-over-handler-modal ref="modalForm1" @ok="modalFormOk"></tr-maoxiayuyingli-over-handler-modal>
...
import TrMaoxiayuyingliMModal from './modules/TrMaoxiayuyingliMModal'
import '@/assets/less/TableExpand.less'
import { formatDate } from '@/utils/util'
import Vue from 'vue'
import { usershebeiList } from '@api/api'
import { getAction } from '@api/manage'
import ChuZhi from '@views/maoxiazl/ChuZhi'
import TrMaoxiayuyingliOverHandlerModal from '@views/maoxiazl/modules/TrMaoxiayuyingliOverHandlerModal.vue'

export default {
  name: 'TrMaoxiayuyingliMList',
