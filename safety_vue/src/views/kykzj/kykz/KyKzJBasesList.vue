    ...
    <div>
      ...
      >
        ...
        <span slot="tag1" slot-scope="tag1, record">
         <span  v-if="record.cjmc != null &&  record.cjmc !=''  ">{{record.cjmc}}</span>
         <span v-else >{{record.sgbw}}</span>
       </span>
...
<!--          <a-divider type="vertical"/>-->
    ...
    <KyKzJBasesModal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
import KyKzJBasesModal from './modules/KyKzJBasesModal'
