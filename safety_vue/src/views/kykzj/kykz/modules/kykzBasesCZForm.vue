  ...
  <a-spin :spinning="confirmLoading">
    ...
    <j-form-container :disabled="formDisabled">
      ...
      <a-form :form="form" slot="detail">
        <a-card title="处理信息" :bordered="false" :headStyle="{color:'#0785fd'}" :bodyStyle="{padding:'10'}"
                style="margin-top:10px">
          <a-row>
            <a-col :span="12">
              <a-form-item label="问题原因" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-model="syjOverHandler.problemReasons" placeholder="无"></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="监理审批" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-model="syjOverHandler.supervisorApproval" placeholder="无"></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="监理结果" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-model="syjOverHandler.supervisorResult" placeholder="无"></a-input>
              </a-form-item>
            </a-col>
          </a-row>
          <a-row>
            <a-col :span="12">
              <a-form-item label="监理处理时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-model="syjOverHandler.supervisorHandleTime" placeholder="无"></a-input>
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item label="审核人" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-input v-model="syjOverHandler.approvalPerson" placeholder="无"></a-input>
              </a-form-item>
            </a-col>
          </a-row>
        </a-card>
