...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        edit: "/zhanglaxxb/trZhanglaXxb/updateUse",
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.visible = true;
      this.$nextTick(() => {
        // this.form.setFieldsValue(pick(this.model, "sgbwname", "uuid",  "yzlc"));
        // this.form.setFieldsValue(pick("", "memo"));
    ...
    //渲染流程表单数据
    getDataList() {
      let params = { baseid: this.model.shebeibianhao+this.model.id };
    ...
    submitForm() {
      ...
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          let formData = {
            id: params.id, //id
            shebeibianhao: params.shebeibianhao,
            uuid: params.uuid, //任务单号
            gjbh: params.sgbwname, //部位
