...
<!--      </a-dropdown>-->
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'zlrwd:status'" v-if="record.wcstatus == '0'">
    ...
    <zhanglarwd-status :flag="flag" :id="id" @change="change"></zhanglarwd-status>
...
<script>
  ...
  import Vue from 'vue'
  import YjrwdStatus from '@views/zlyj/yjrwdStatus'
  import ZhanglarwdStatus from '@views/zlyj/zhanglarwdStatus'
  ...
  export default {
    ...
    methods: {
      ...
      zhanglamessageList(uuid) {
        let params = {
            uuid: uuid,
        }
        getAction('/zhanglaxxb/trZhanglaXxb/list47', params).then((res) => {
          if(res.success){
            if(res.result.records.length > 0){
              let syjid = res.result.records[0].syjid
