  ...
  <a-card :bordered="false">
    ...
    <div>
      ...
      >
        ...
        <span slot="bindrwd" slot-scope="hege, record">
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'zl:rwtb'" v-if="record.bindrwd == null" @click="handleEdit1(record)">填报</a>
          <a v-has="'zl:rwsh'" v-if="record.bindrwd == 10"  @click="handleEdit1(record)">审核</a>
    ...
    <TBTrZhanglaXxbModal ref="modalForm1" @ok="modalFormOk"></TBTrZhanglaXxbModal>
  </a-card>
</template>
...
import TBTrZhanglaXxbModal from './modules/TBTrZhanglaXxbModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/zhanglaxxb/trZhanglaXxb/list47NoUse',
