       ...
       <span slot="hege" slot-scope="status, record">
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
             <a-menu-item v-has="'zhangla:cz'" v-if="record.zhanglaYajiangOverHandler.overproofStatus == '0'||record.zhanglaYajiangOverHandler.overproofStatus == '30'">
                <a @click="showmadelchuzhi(record.syjid,1)">处置</a>
              </a-menu-item>
              <a-menu-item v-has="'zhangla:sh'">
                <a @click="showmadelshenhe(record.syjid,1)" v-if="record.zhanglaYajiangOverHandler.overproofStatus == '10'">审核</a>
              </a-menu-item>
              <a-menu-item v-has="'zhangla:bh'" v-if="record.zhanglaYajiangOverHandler.overproofStatus == '10'">
                <a @click="showmadelbohui(record.syjid,1)">驳回</a>
              </a-menu-item>
            </a-menu>
          </a-dropdown>
        </span>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/zhanglam/trZhanglaM/list5',
