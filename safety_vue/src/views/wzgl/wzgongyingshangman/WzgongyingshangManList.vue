<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" v-has="'wgysml:add'" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'wgysml:dc'" @click="handleExportXls('wzgongyingshang_man')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'wgysml:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
...
<!--      </a-dropdown>-->
    ...
    <div>
      ...
      >
        ...
        <span slot="states" slot-scope="status, record">
          <a-tag color="green" v-if="record.states == '0'">正常</a-tag>
          <a-tag color="red" v-if="record.states == '1'">异常</a-tag>
       </span>
        <span slot="isdel" slot-scope="status, record">
          <a-tag color="red" v-if="record.isdel == '0'">否</a-tag>
          <a-tag color="green" v-if="record.isdel == '1'">是</a-tag>
       </span>
