...
<!--        </template>-->
    ...
    <bhzpouretaizhang-modal ref="modalForm" @ok="modalFormOk"></bhzpouretaizhang-modal>
  </a-card>
</template>
...
<script>
  ...
  import Vue from 'vue'
  import BhzpouretaizhangForm from '@views/wzgl/bhzpouretaizhang/modules/BhzpouretaizhangForm'
  import BhzpouretaizhangModal from '@views/wzgl/bhzpouretaizhang/modules/BhzpouretaizhangModal'
  export default {
    name: 'BhzpouretaizhangList',
    mixins:[JeecgListMixin, mixinDevice],
    components: {
      BhzpouretaizhangModal,
      BhzpouretaizhangForm,
      JSuperQuery,
    },
    data () {
      return {
