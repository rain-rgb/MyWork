...
<!--              <a-input-number v-decorator="['devicename']" placeholder="请输入devicename" style="width: 100%" />-->
<!--            </a-form-item>-->
<!--          </a-col>-->
<!--          <a-col :span="24">-->
...
<script>
  ...
  export default {
    name: 'FrontDischargeholeDataForm',
    components: {
      JFormContainer,
      JDate,
    },
    ...
    data () {
      return {
        ...
        url: {
          add: "/clkhistory/frontDischargeholeData/add",
          edit: "/clkhistory/frontDischargeholeData/edit",
          queryById: "/clkhistory/frontDischargeholeData/queryById"
        }
      }
    },
    computed: {
