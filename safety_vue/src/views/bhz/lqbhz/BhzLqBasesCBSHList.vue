<template>
  <a-card :bordered="false">
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item v-has="'lqbhz:bh'">
                <a @click="showmadel2(record)">驳回</a>
              </a-menu-item>
              <a-menu-item v-has="'lqbhz:sh'">
    ...
    <bo-hui :flag="flag" :bhz="bhz" :hntbatch="guid" @change="change3"></bo-hui>
...
export default {
  ...
  methods: {
    showmadel: function (record) {
      if (record.bhzCementOverHandler.overproofStatus === 10) {
