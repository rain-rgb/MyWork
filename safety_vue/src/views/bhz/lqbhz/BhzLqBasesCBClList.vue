<template>
  <a-card :bordered="false">
    ...
    <div>
      ...
      >
        ...
        <span slot="tags1" slot-scope="tags1, record">
          ...
          <a-tag color="orange" v-if="record.bhzCementOverHandler.overproofStatus === 10">施工方已处理</a-tag>
          <a-tag color="yellow" v-if="record.bhzCementOverHandler.overproofStatus === 20">已闭合</a-tag>
          ...
          <a-tag color="red" v-if="record.bhzCementOverHandler.overproofStatus === 60">指挥部已驳回</a-tag>
       </span>
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay" v-show="record.bhzCementOverHandler.overproofStatus !== 20">
              <a-menu-item v-has="'lqbhz:cz'" v-show="record.bhzCementOverHandler.overproofStatus === 0 ||record.bhzCementOverHandler.overproofStatus === 30">
                <a @click="showmadel1(record)">施工处置</a>
              </a-menu-item>
              <a-menu-item v-has="'lqbhz:sh'" v-show="record.bhzCementOverHandler.overproofStatus === 10 ||record.bhzCementOverHandler.overproofStatus === 60">
                <a @click="showmadel2(record)">监理审核</a>
              </a-menu-item>
              <a-menu-item v-has="'lqbhz:sp'" v-show="record.bhzCementOverHandler.overproofStatus === 40">
    ...
    <bhz-lq-base-c-b-c-x-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
import BhzLqBaseCBCXModal from '@views/bhz/lqbhz/modules/BhzLqBaseCBCXModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/lqbhz/bhzLqBases//czshlist',
