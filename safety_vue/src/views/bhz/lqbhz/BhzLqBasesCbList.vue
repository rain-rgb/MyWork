<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button v-has="'lqbhzchaobiao:add'" @click="handleAdd" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'lqbhzchaobiao:dc'" icon="download" @click="handleExportXls('沥青主表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl"
                @change="handleImportExcel">
        <a-button type="primary" v-has="'lqbhzchaobiao:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'lqbhzchaobiao:edit'" @click="handleEdit(record)">编辑</a>

          <a-divider v-has="'lqbhzchaobiao:edit'" type="vertical"/>
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'lqbhzchaobiao:del'">
    ...
    <BhzLqBaseCBCXModal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
import BhzLqBaseCBCXModal from './modules/BhzLqBaseCBCXModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/lqbhz/bhzLqBases/ChaoBiaolist',
