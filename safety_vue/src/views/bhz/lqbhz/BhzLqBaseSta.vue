  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      ...
      <a-row>
        ...
        <a-card title = "产能" :bordered="false" :headStyle="{color:'#0785fd'}" :bodyStyle="{padding:'10'}">
...
import LineChartMultid from '@comp/chart/BhzStafangliangLiq'
...
export default {
  ...
  data() {
    return {
      ...
      dataSource2: [],
      url: {
        list:"/lqbhz/bhzLqBases/list7",
        list2:"/lqbhz/bhzLqBases/list8",
      },
      dictOptions:{}
    }
  },
  ...
  methods: {
    ...
    bhzsta:function (){ //超标盘数柱状图
      let params = {shebeibianhao:this.cx,date:this.dates};
      this.dataSource=[];
