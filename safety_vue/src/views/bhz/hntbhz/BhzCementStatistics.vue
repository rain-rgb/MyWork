...
<!-- 统计导出 -->
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="统计时间范围">
              <j-date placeholder="开始时间" v-model="queryParam.statisticsTime_begin" :showTime="true" dateFormat="YYYY-MM-DD" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="">
              <j-date placeholder="结束时间" v-model="queryParam.statisticsTime_end" :showTime="true" dateFormat="YYYY-MM-DD" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'hntbhzex:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'hntbhzex:dc'" icon="download" @click="handleExportXls('拌合站超标统计表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'hntbhzex:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 禁用高级查询区域 -->
...
<!--       </span>-->
        ...
        <span slot="action"  slot-scope="text, record">
          <a v-has="'hntbhzex:edit'" @click="handleEdit(record)">编辑</a>
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item v-has="'hntbhzex:del'">
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/bhzStatistics/bhzCementStatistics/liststadc",
        delete: "/hntbhz/bhzCementBase/delete",
        deleteBatch: "/hntbhz/bhzCementBase/deleteBatch",
        exportXlsUrl: "/bhzStatistics/bhzCementStatistics/exportXlsta",
