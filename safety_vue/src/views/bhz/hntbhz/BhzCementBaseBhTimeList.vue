<template>
  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="拌合时间">
              <a-input placeholder="请输入拌合时间" v-model="queryParam.stirDatetime"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'hntbhztime:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'hntbhztime:dc'" icon="download" @click="handleExportXls('拌合站主表')"
        >导出</a-button
      >
      <a-upload
        name="file"
      ...
      >
        <a-button type="primary" v-has="'hntbhztime:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 禁用高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="delayed" slot-scope="delayed, record">
          <a-tag color="green" v-if="compareTime(record.productDatetime, record.saveDatetime) == 'no'">否</a-tag>
          <a-tag color="red" v-if="compareTime(record.productDatetime, record.saveDatetime) == 'yes'">是</a-tag>
        </span>
...
<!--          <a v-has="'hntbhztime:edit'" @click="handleEdit(record)">编辑</a>-->

<!--          <a-divider type="vertical" v-has="'hntbhztime:edit'" />-->
<!--          <a-dropdown>-->
...
<!--              -->
<!--              </a-menu-item>-->
<!--              <a-menu-item v-has="'hntbhztime:del'">-->
...
import BhzCementBaseModal from './modules/BhzCementBaseTimeModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/hntbhz/bhzCementBase/bhTimeList',
  ...
  methods: {
    ...
    compareTime(oldTime, newTime) {
      return new Date(newTime).getTime() / 1000 - new Date(oldTime).getTime() / 1000 > 7200 ? 'yes' : 'no'
    },
  },
}
</script>
