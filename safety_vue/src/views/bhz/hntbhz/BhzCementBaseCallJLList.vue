        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="处置状态">
              <j-dict-select-tag placeholder="请选择处置状态" v-model="queryParam.overproofStatus"
                                 dictCode="overproof_status"></j-dict-select-tag>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
      ...
      <a-table
       ...
       <span slot="tags" slot-scope="tags, record">
        ...
        <span slot="tags2" slot-scope="tags2, record">
          <a-tag color="red" v-if="record.bhzCementOverHandler.overproofStatus === 0 || record.bhzCementOverHandler.overproofStatus === 30 ">{{record.bhzCallCfg.czperson}}</a-tag>
          <a-tag color="green" v-else-if="record.bhzCementOverHandler.overproofStatus >= 10 ">{{record.bhzCallCfg.czperson}}</a-tag>
<!--          <a-tag color="red" v-if="record.overLevel === 1 && record.bhzCementOverHandler.overproofStatus === 0 || record.bhzCementOverHandler.overproofStatus === 30 ">{{record.bhzCallCfg.czperson}}</a-tag>-->
<!--          <a-tag color="green" v-if="record.overLevel === 1 && record.bhzCementOverHandler.overproofStatus >= 10 ">{{record.bhzCallCfg.czperson}}</a-tag>-->
       </span>
        <span slot="tags3"  slot-scope="tags3, record">
           <a-tag color="red" v-if="record.overLevel !== 1 && (record.bhzCementOverHandler.overproofStatus <= 10  || record.bhzCementOverHandler.overproofStatus === 60 )" >{{record.bhzCallCfg.shperson}}</a-tag>
           <a-tag color="green" v-else-if="record.overLevel === 1"></a-tag>
          <a-tag color="green" v-else>{{record.bhzCallCfg.shperson}}</a-tag>
       </span>
        <span slot="tags4"  slot-scope="tags4, record">
          <a-tag color="green" v-if="record.overLevel === 3 && ( record.bhzCementOverHandler.overproofStatus === 20 || record.bhzCementOverHandler.overproofStatus >40 )">{{record.bhzCallCfg.spperson}}</a-tag>
           <a-tag color="green" v-else-if="record.overLevel < 3"></a-tag>
          <a-tag color="red" v-else>{{record.bhzCallCfg.spperson}}</a-tag>
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title:'处置人',
          align:"center",
          dataIndex: 'bhzCallCfg.czperson',
          key:'bhzCallCfg.czperson',
          scopedSlots: { customRender: 'tags2' },
        },
        {
          title:'审核人',
          align:"center",
          dataIndex: 'bhzCallCfg.shperson',
          key:'bhzCallCfg.shperson',
          scopedSlots: { customRender: 'tags3' },
        },
        {
          title:'复核人',
          align:"center",
          dataIndex: 'bhzCallCfg.spperson',
          key:'bhzCallCfg.spperson',
      ...
      url: {
        list: "/hntbhz/bhzCementBase/listCall",
  ...
  methods: {
    ...
    createZLD:function (){
      Vue.prototype.$Jnotification.warn({ message: '提示', description: '未提供指令单模板无法生成' })
    },
