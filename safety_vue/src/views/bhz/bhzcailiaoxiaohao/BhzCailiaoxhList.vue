    ...
    <div>
      ...
      >
        <span class="separate" slot="cement1" slot-scope="text,record" >
          <div v-for="(item,index) in record.bhzCementDetailStatisticsList">
        ...
        <span class="separate" slot="cement2" slot-scope="text,record" >
          <div v-for="(item,index) in record.bhzCementDetailStatisticsList">
             <a-divider style="margin:0;height:1px" />
             <div>{{item.theoryNumber.toFixed(2)}}</div>
          </div>
        </span>
        <span class="separate" slot="cement3" slot-scope="text,record" >
          <div v-for="(item,index) in record.bhzCementDetailStatisticsList">
             <a-divider style="margin:0;height:1px" />
             <div>{{item.realityNumber.toFixed(2)}}</div>
          </div>
        </span>
...
<!--          <chu-zhi :flag="flag" :hntbatch="record.batchNo" @change="change2"></chu-zhi>-->
    ...
    <BhzCailiaoxhModal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
import BhzCailiaoxhModal from './modules/BhzCailiaoxhModal'
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/bhzStatistics/bhzCementStatistics/list1",
        delete: "/bhzStatistics/bhzCementStatistics/delete",
