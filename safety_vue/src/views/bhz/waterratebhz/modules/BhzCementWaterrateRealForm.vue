    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="料仓id" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="liaocangid">
              <a-input v-model="model.liaocangid" placeholder="请输入料仓id"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="料仓名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="lcname">
              <a-input v-model="model.lcname" placeholder="请输入料仓名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="平均含水率" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="averate">
              <a-input v-model="model.averate" placeholder="请输入平均含水率"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="平均湿度" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="avehum">
              <a-input v-model="model.avehum" placeholder="请输入平均湿度"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
