<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('wzcontact_s')">导出</a-button>
    ...
    <wzcontact-s-modal ref="modalForm" @ok="modalFormOk"></wzcontact-s-modal>
  </a-card>
</template>
...
<script>
  ...
  import WzcontactSModal from './modules/WzcontactSModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/wzcontact/wzcontactS/list",
          delete: "/wzcontact/wzcontactS/delete",
          deleteBatch: "/wzcontact/wzcontactS/deleteBatch",
          exportXlsUrl: "/wzcontact/wzcontactS/exportXls",
          importExcelUrl: "wzcontact/wzcontactS/importExcel",
