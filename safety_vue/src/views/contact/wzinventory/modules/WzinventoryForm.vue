    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="盘点数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="pdnum">
              <a-input v-model="model.pdnum" placeholder="请输入盘点数量"></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
        <a-row>
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-model-item label="计算依据" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="jisuanyiju">
              <a-input v-model="model.jisuanyiju" placeholder="请输入计算依据"></a-input>
            </a-form-model-item>
          </a-col>
          <!--          <a-col :span="12">-->
          <!--            <a-form-model-item label="账期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="zhangqi">-->
          <!--              <a-input v-model="model.zhangqi" placeholder="请输入账期"></a-input>-->
          <!--            </a-form-model-item>-->
          <!--          </a-col>-->
        </a-row>
        <a-row>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        add: '/inventory/wzinventory/add',
        edit: '/inventory/wzinventory/edit',
        queryById: '/inventory/wzinventory/queryById',
  ...
  methods: {
    ...
    // getFuzhuGuige: function () {
    //   var params = {
    //     parentnode: this.model.kubie,
    //     chandi: this.model.leibie,
    //     cailiaoname: this.model.wzName
    //   }
    //   getAction(this.url.getFuzhuGuigeList, params).then(res => {
    //     this.dictOption6 = []
    //     let result = res.result
    //     result.forEach(re => {
    //       this.dictOption6.push({ text: re.miaoshu, value: re.miaoshu })
