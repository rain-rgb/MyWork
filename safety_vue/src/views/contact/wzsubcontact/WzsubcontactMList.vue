  ...
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" type="primary" icon="plus">新增</a-button>
            <a-button type="primary" icon="download" @click="handleExportXls('分包方合同台账')">导出</a-button>
      ...
      <a-table
        ...
        @change="handleTableChange">
         ...
         <span slot="tags" slot-scope="tags, record">
          <a-tag v-if="record.projType == '1'">临时工程</a-tag>
          <a-tag v-if="record.projType == '2'">主体工程</a-tag>
        </span>
    ...
    <wzsubcontact-m-modal ref="modalForm" @ok="modalFormOk"></wzsubcontact-m-modal>
  </a-card>
</template>
...
import WzsubcontactMModal from './modules/WzsubcontactMModal'

export default {
  name: 'WzsubcontactMList',
  ...
  data() {
    return {
      description: 'wzsubcontact_m管理页面',
      selectValue: '',
      dictOptions1: [{
        text: '正在履约',
        value: '1'
      ...
      url: {
        list: '/wzsubcontact/wzsubcontactM/list',
        delete: '/wzsubcontact/wzsubcontactM/delete',
        deleteBatch: '/wzsubcontact/wzsubcontactM/deleteBatch',
        exportXlsUrl: '/wzsubcontact/wzsubcontactM/exportXls',
        importExcelUrl: 'wzsubcontact/wzsubcontactM/importExcel',
  ...
  methods: {
    ...
    getSuperFieldList() {
      let fieldList = []
      fieldList.push({ type: 'string', value: 'projType', text: '工程类型' })
      ...
      fieldList.push({
        type: 'string', value: 'remarks', text: '履约进度，1、正在履约；2、已退场，已封账；3、已退场，未封账。'
      })
