    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="0-安徽环宇公路沥青材料有限公司;1-上海海太工程科技有限公司;2-湖南路安达沥青技术有限公司" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="ghdw">
              <a-input v-model="model.ghdw" placeholder="请输入0-安徽环宇公路沥青材料有限公司;1-上海海太工程科技有限公司;2-湖南路安达沥青技术有限公司"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="理论消耗数量由理论配合比和工程任务单计算得出" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="llxhsl">
              <a-input v-model="model.llxhsl" placeholder="请输入理论消耗数量由理论配合比和工程任务单计算得出"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="理论库存 = 实际进场 - 理论消耗" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="llkc">
          ...
          <a-col :span="24">
            <a-form-model-item label="照片地址" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="imgfile">
              <a-input v-model="model.imgfile" placeholder="请输入照片地址"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
