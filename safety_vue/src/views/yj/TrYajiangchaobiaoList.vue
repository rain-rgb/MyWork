  ...
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="处理状态">
              <j-search-select-tag placeholder="请选择处理状态" v-model="queryParam.overproofStatus" :dictOptions="dictOption1"/>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div>
      ...
      >
        ...
        <!-- 在这里添加状态值时，也要在dictOption1中新增状态选项-->
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/yajiangs/trYajiangS/list34',
