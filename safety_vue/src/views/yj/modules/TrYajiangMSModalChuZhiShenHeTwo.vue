...
<!--                </a-table>-->
        ...
        <a-tabs @change="callback">
            <a-tab-pane v-for="item in holeidList" :key="item.holeid" :tab="item.kongdao">
                <a-form>
...
export default {
    ...
    methods: {
      ...
      overHandler() {
        ...
        getHoleidList() {
            let param = { syjid: this.syjid, type: 1, status: 10 }
        ...
        callchuzhishenhe(e) {
            this.syjid = e.syjid
            this.overLevel = e.yajiangs[0].overproofStatus
            this.visible = true
            this.zhanglamessage()
            this.getHoleidList()
        },
