  ...
  export default {
    ...
    props: {
      ...
      dataSource: {
        type: Array,
        default: () => [
          { type: 'Jan111111111', jeecg: 7.0, jeebt: 3.9 },
          { type: 'Feb111111', jeecg: 6.9, jeebt: 4.2 },
          { type: 'Mar11111111', jeecg: 9.5, jeebt: 5.7 },
          { type: 'Apr111111111111', jeecg: 14.5, jeebt: 8.5 },
      ...
      fields: {
        type: Array,
        default: () => ['进浆压力(MPa)','返浆压力(MPa)','进浆量(L)','返浆量(L)']//
      },
