          ...
          <a-row>
            <a-col :span="12">
              <a-form-item label="设备名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <j-search-select-tag  placeholder="请选择设备名称" v-decorator="['shebeibianh', validatorRules.shebeibianh]" :dictOptions="dictOption">
                </j-search-select-tag>
                {{ selectValue }}
              </a-form-item>
            </a-col>
...
<!--              <a-input v-decorator="['sgbwname']" placeholder="施工部位"  :disabled="true"></a-input>-->
<!--            </a-form-item>-->
<!--          </a-col>-->
<!--        </a-row>-->
<!--        <a-row>-->
<!--          <a-col :span="24">-->
<!--            <a-form-item label="施工部位" :labelCol="labelCol1" :wrapperCol="wrapperCol1">-->
<!--              <a-input v-decorator="['projectname']" placeholder="工程名称"  :disabled="true"></a-input>-->
<!--            </a-form-item>-->
<!--            </a-col>-->
<!--        </a-row>-->
            <a-row>
          <a-col :span="12">
              <a-form-item label="一次张拉日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
                <a-date-picker placeholder="请选择一次张拉日期" v-decorator="['zldate']" style="width: 100%" :trigger-change="true" />
              </a-form-item>
          </a-col>
          <a-col :span="12">
        ...
        <a-row>
          <a-col :span="12">
            <a-form-item label="混凝土的设计强度" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['hntsjqd']" :trigger-change="true" dictCode="betlev" placeholder="请选择混凝土的设计强度" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'uuid','projectname','girderplace','component','sgbwuuid','sgbwname','pedestal','status','zldate','createTime','updateTime','departid','sjzll','createBy','sysOrgCode','zldate2','sjzll2','status2','departname','shebeibianh','yylgczlgg','yylgccdpp','yylgcbh','mjjzlgg','mjjcdpp','mjjbh','mdbzlgg','mdbcdpp','mdbbh','lbgd','hntsjqd','zllwc'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'uuid','projectname','girderplace','component','sgbwuuid','sgbwname','pedestal','status','zldate','createTime','updateTime','departid','sjzll','createBy','sysOrgCode','zldate2','sjzll2','status2','departname','shebeibianh','yylgczlgg','yylgccdpp','yylgcbh','mjjzlgg','mjjcdpp','mjjbh','mdbzlgg','mdbcdpp','mdbbh','lbgd','hntsjqd','zllwc'))
      },
    }
  }
</script>