...
<!--          </a-col>-->
    ...
    <div class="table-operator">
      <a-button v-has="'tpny:add'" @click="handleAdd" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" v-has="'tpny:dc'" icon="download" @click="handleExportXls('摊铺碾压数据监测主表')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'tpny:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'tpny:edit'" @click="handleEdit(record)">编辑</a>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/tpny/frontDeviceRealdata/list",
