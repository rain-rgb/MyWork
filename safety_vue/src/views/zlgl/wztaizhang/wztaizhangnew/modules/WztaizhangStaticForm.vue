        ...
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="材料名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="cailiaono">
              <a-input v-model="model.cailiaono_dictText" placeholder="请输入材料编号"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="供应商单位" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="gongyingshangdanweibianma">
              <a-input v-model="model.gongyingshangdanweibianma_dictText" placeholder="请输入供应商单位编码"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="进场总数量" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="jingzhongt">
              <a-input-number v-model="model.jingzhongt" placeholder="请输入jingzhongt" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="批次总数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="picicount">
              <a-input-number v-model="model.picicount" placeholder="请输入picicount" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="自检批次数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="jianyanstate">
              <a-input-number v-model="model.jianyanstate" placeholder="请输入jianyanstate" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="抽检批次数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="choujianstate">
