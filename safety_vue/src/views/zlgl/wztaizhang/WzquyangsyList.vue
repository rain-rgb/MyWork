<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button @click="handleAdd" v-has="'wzquyang:add'" type="primary" icon="plus">新增</a-button>
      <a-button type="primary" icon="download" v-has="'wzquyang:dc'" @click="handleExportXls('wzquyang')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button type="primary" v-has="'wzquyang:dr'" icon="import">导入</a-button>
      </a-upload>
      <!-- 高级查询区域 -->
    ...
    <div>
      ...
      >
        ...
        <span slot="action" slot-scope="text, record">
          <a v-has="'wzquyang:edit'" @click="handleEdit(record)">编辑</a>
          <a-dropdown>
            <a class="ant-dropdown-link">取样<a-icon type="down" /></a>
            <a-menu slot="overlay">
              <a-menu-item v-has="'wzquyang:quyang'" >
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              <a-menu-item v-has="'wzquyang:baogao'" >
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/wztaizhang/wztaizhang/list1",
