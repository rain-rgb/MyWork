  ...
  <a-card :bordered="false">
    ...
    <div>
      ...
      >
        ...
        <span slot="plsczl" slot-scope="text, record">
          <a-input oninput="value=value.replace(/[^(\-|\+)?\d+(\.\d+)]/g,'')" type="text" v-model='record.plsczl'></a-input>
        </span>
        <span slot="zjzl"  slot-scope="text, record">
          <a-input oninput="value=value.replace(/[^(\-|\+)?\d+(\.\d+)]/g,'')" type="text" v-model='record.zjzl'></a-input>
        </span>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            scopedSlots: { customRender: 'plsczl' }
          },
          // {
          //   title:'已注浆井数量',
          //   align:"center",
          //   key: 'groutingWellsNumber',
        ...
        url: {
          ...
          sjtjedit: "/mixin/station/update/log/saveMixinStationInfoUpdateLog"
        },
        dictOptions:{},
        superFieldList:[],
      }
