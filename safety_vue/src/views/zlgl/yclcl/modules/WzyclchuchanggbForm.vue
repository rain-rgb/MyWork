  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list:"/yclcl/wzyclchuchanggb/list1",
          add: "/yclcl/wzyclchuchanggb/add",
          edit: "/yclcl/wzyclchuchanggb/edit",
          queryById: "/yclcl/wzyclchuchanggb/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jinchuliaodanno','cailiaono_dictText','jinchangshijian','chuchangshijian','pici','cheliangbianhao','qianchepai','houchepai','maozhong','pizhong','jingzhong','kouzhong','koulv','chengzhongpiancha','lcbianhao_dictText','sibangyuan','remark','shebeibianhao_dictText','gongyingshangdanweibianma_dictText','guobangleibie','cheliangleixing','status','isdel','ts','guid','maozhongt','pizhongt','candi','yunshudanwei','lcbianhao','isshouliao','jingzhongt','istongji','jcgkpic','jccppic','jchcppic','jcbfpic','ccgkpic','cccppic','cchcppic','ccbfpic','liaocangid','serialno','reason','fileUpload','beizhu','projectid','constructionsite'))
          this.getData();
        })
