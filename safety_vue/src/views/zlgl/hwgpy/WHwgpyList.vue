        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="时间范围">
              <j-date
                placeholder="开始时间范围"
                v-model="queryParam.datetime_begin"
                :showTime="true"
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="">
              <j-date
                placeholder="结束时间范围"
                v-model="queryParam.datetime_end"
                :showTime="true"
                dateFormat="YYYY-MM-DD HH:mm:ss"
              />
            </a-form-item>
    ...
    <div>
      ...
      <a-table
        ...
        <span slot="result" slot-scope="result, record">
          <span style="color: green" v-if="record.result == '0'">匹配</span>
          <span style="color: red" v-if="record.result == '1'">不匹配</span>
        </span>
        <span slot="type" slot-scope="type, record">
          <span v-if="record.type == '1'">普通沥青</span>
          <span v-if="record.type == '2'">改性沥青</span>
        </span>
