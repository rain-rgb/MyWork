    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="理论金额" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="theoreticalAmount">
              <a-input-number v-model="model.theoreticalAmount" placeholder="请输入理论金额" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/changecostcontrol/changeCostControl/add",
          edit: "/changecostcontrol/changeCostControl/edit",
          queryById: "/changecostcontrol/changeCostControl/queryById"
        }
      }
    },
    computed: {
