<template>
  <div :style="{ padding: '0 0 32px 32px',width: 'auto',overflow: 'auto' }">
    <h4 :style="{ marginBottom: '20px' }">{{ title }}</h4>
    <v-chart :force-fit="false" :height="height" :width="3000" :data="data" :scale="scale" :padding="padding" :onClick="handleClick">
      <v-tooltip />
      <v-axis />
      <v-legend />
