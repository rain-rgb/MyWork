<template>
  <div class="components-input-demo-presuffix">
    ...
    <j-select-roadwork-modal
      ref="innerRoadworkModel"
...
<script>
  import JSelectRoadworkModal from './modal/JSelectRoadworkModel'
  export default {
    name: 'JSelectRoadwork',
    components:{
      JSelectRoadworkModal
    },
    props:{
      modalWidth:{
        type:Number,
    ...
    methods:{
      initComp(departNames){
        ...
        if(this.customReturnField !== 'id' && this.value){
          const dataList = this.$refs.innerRoadworkModel.dataList;
      ...
      openModal(){
        this.$refs.innerRoadworkModel.show()
      },
      handleOK(rows, idstr) {
        let value = ''
