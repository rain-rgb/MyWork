...
// let jsToken = window._CONFIG['JSURL'] || '/js'//视频查看获取token取消跨域问题(通过后台接口获取)
...
// const services = axios.create({视频查看获取token取消跨域问题(通过后台接口获取))
//   //baseURL: '/jeecg-boot',
//   baseURL: jsToken, // api base_url
...
export {
  ...
  service as axios,
  // services as tokens //视频播放token获取通过后台接口
